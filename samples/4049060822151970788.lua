...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(-2.500000), always_number(nil), always_number(false) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(-2.171875), always_number(-128.000122), always_number(-2.171875) do
