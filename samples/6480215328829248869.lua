...
while  (setmetatable({ '', [ not_nan_and_nil(415.945312) ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(402.695312) ] = '' }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
until nil; 
while  (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(400.007813) ] = '', '' }, table_mt))() do
