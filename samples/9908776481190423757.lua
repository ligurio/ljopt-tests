...
---------------------- END OF PREAMBLE ----------------------------
Name0 =  (setmetatable({ nan, nan }, table_mt))() == '', '', '',  (setmetatable({  (setmetatable({ Name0 = '' }, table_mt))(), nan, }, table_mt))() ; 
Name0 =  (setmetatable({  (setmetatable({ Name0 = '' }, table_mt))(), nan, }, table_mt))() +  (setmetatable({  }, table_mt))(),  (setmetatable({ nan, nan }, table_mt))() ; 
