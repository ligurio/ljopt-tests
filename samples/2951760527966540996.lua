...
; 
while  (setmetatable({ [ not_nan_and_nil('abc') ] = '' }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name0  (setmetatable({ 1000.000000 }, table_mt))().Name , Name0  = Name0.coroutine_close, '\'', Name0  (setmetatable({ Name0 = '' }, table_mt))() ; 
function Name0(  )
