...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(-2.000000), always_number(false) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(''), always_number('') do
...
; 
for Name0 = always_number(-0.000000), always_number(not  '') do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(''), always_number(-0.000000) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for Name2 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(Name0), always_number('') do
