...
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil(true) ] = '', Name0 = -416.000000 ^ 116.953170, -0.000000, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', -0.000000, -0.000000 }, table_mt))() do
