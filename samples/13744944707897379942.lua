...
while  (setmetatable({ [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = not  Name0:Name0  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] = '', Name0:Name0  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(Name0:____________________  (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() do
