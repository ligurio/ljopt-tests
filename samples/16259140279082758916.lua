...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(20.500000), always_number(''), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  ... , 1000.000000, 3.000000, -0.000000, 2.000000, 20.500000, 44.000000, 4.000000, 34.000000, 168.000000, 0.000000, Name0:Name0  (setmetatable({  }, table_mt))(),  ...  ; 
end
; 
for Name0 = always_number(''), always_number( (setmetatable({ [ not_nan_and_nil(not  0.000000) ] = '', [ not_nan_and_nil(32.429688) ] =  ... , [ not_nan_and_nil(-60.000008) ] =  ...  }, table_mt))()), always_number(-0.000000) do
