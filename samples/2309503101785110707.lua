...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(''), always_number(# only_numbers_cmp('', '<', true) %  ...  .. true or ''), always_number(-0.000000) do
...
for ____ = always_number( (setmetatable({ [ not_nan_and_nil(-0.000000) ] = nil, [ not_nan_and_nil(Name0) ] = '', Name0 = '' }, table_mt))()), always_number(7.000000), always_number(Name0) do
