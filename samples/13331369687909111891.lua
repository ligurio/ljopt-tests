...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ nil }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '', nil }, table_mt))()) ] = '', [ not_nan_and_nil( (setmetatable({ Name0 = '', nil }, table_mt))()) ] = '', nil }, table_mt))() do
