...
counter_0 = counter_0 + 1;
 ...
 ; 
Name0:Name0  (setmetatable({  }, table_mt))()[(Name0 and  (setmetatable({  }, table_mt))())[''] and  (setmetatable({  }, table_mt))()], Name0:Name0  (setmetatable({  }, table_mt))()[only_numbers_cmp(true, '<=', nil)] , Name0  = nil,  ...  ; 
