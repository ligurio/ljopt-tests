...
Name0[Name0], Name0[Name0] , Name0 , Name0[-0.000050] , _  = false, true ; 
do
end
; 
Name0[Name0], Name0 , Name0 , ( (setmetatable({ [ not_nan_and_nil(function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
) ] = '' ==  ... , [ not_nan_and_nil(-1000.000000 / 4.000000) ] = -1000.000000, }, table_mt))())[Name0] , Name0  = '' ; 
