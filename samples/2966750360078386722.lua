...
; 
Name0, Name0 , Name0 , Name0 , ( (setmetatable({  ... , }, table_mt))())[#  (setmetatable({  }, table_mt))()] , ( (setmetatable({ Name0 = '', }, table_mt))())[#  (setmetatable({  }, table_mt))()] , ( (setmetatable({  }, table_mt))())[nil] , math_tan , Name0  = #  (setmetatable({  }, table_mt))() ; 
until  ... ; 
