...
counter_1 = 0
Name0 = '' ; 
for Name0 = always_number(-0.000050), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
if  (setmetatable({  (setmetatable({ function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
Name0 = '' ; 
end
, Name0 = '', [ not_nan_and_nil('') ] = -0.000050 }, table_mt))(), ____________________ = '', Name0 = '', [ not_nan_and_nil((nil)) ] = -0.000050 }, table_mt))() then
	end
; 
end
; 
