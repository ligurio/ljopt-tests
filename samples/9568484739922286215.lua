...
counter_0 = 0
Name0 = '' ; 
for Name2 = always_number(''), always_number(5.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] = '' }, table_mt))() ; 
Name0 = '' ; 
end
; 
