...
counter_1 = 0
counter_2 = 0
for _ = always_number(44.500000), always_number(''), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = -1.062498, 3.125000, 1.999995, 44.003186, 3.000000, '', 34.000000, 4.000004, 4.000000, 3.000000, 0.000000, Name0:Name0  (setmetatable({  }, table_mt))(),  ...  ; 
end
; 
for Name0 in ''  do
