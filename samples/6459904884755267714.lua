...
for Name0 = always_number(''), always_number( (setmetatable({ [ not_nan_and_nil(true) ] = -0.000000, -0.000000 }, table_mt))()) do
...
; 
for Name1 = always_number(''), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
Name9, Name0 , Name9  = '', Name9 ; 
end
; 
end
; 
