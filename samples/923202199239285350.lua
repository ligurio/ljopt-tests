...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(0.000000), always_number(4.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(# ''), always_number(4.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(true), always_number(false) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for ____________________ = always_number(nil), always_number(4.000000), always_number(4.000000) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
while '' == '' ..  (setmetatable({  }, table_mt))() ..  (setmetatable({  }, table_mt))() .. '' do
