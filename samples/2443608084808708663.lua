...
---------------------- END OF PREAMBLE ----------------------------
Name0 = -0.000050 / -0.000031, 2.000000 / not   (setmetatable({ -0.000000 * '', Name0 = '', Name0 = '', Name0 = '', ( (setmetatable({ [ not_nan_and_nil(false) ] = '' }, table_mt))()).Name, Name0 = '', Name0 = '', Name0 = '' }, table_mt))() ; 
