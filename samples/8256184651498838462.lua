...
counter_0 = 0
counter_1 = 0
for ____ = always_number(-2.022949), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
local Name0; 
Name0 = '' ; 
for ____ = always_number( (setmetatable({ [ not_nan_and_nil(-0.000000) ] = nil, Name0 = '' }, table_mt))()), always_number(7.000000), always_number(Name0) do
