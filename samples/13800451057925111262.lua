...
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', 'coroutine.wrap' == '', [ not_nan_and_nil('utf8') ] = '', nil,  (setmetatable({  }, table_mt))(), nan, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', -0.000000, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() do
