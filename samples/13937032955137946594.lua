...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(3.000000), always_number('' - 3.000000 -  (setmetatable({ Name0 = ''; }, table_mt))() - ''), always_number(3.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for io = always_number(3.000000), always_number(3.000000 - 3.000000 - 3.000000 ^ 3.000000 - 3.000000 - '' - 0.000000) do
