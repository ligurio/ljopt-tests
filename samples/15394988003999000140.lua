...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ -0.000000, -0.000000, -0.000000, -0.000000, -0.000000, -0.000000, Name0 = '', -0.000000, -0.000000, -0.000000, -0.000000, -0.000000, -0.000000 }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0  (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] = '' }, table_mt))(); 
