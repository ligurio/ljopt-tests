...
; 
for Name6 = always_number(Name0), always_number(2.000000), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name0 = always_number(Name0), always_number(0.000000), always_number(2.000000) do
...
; 
for Name0 = always_number(''), always_number('1') do
