...
counter_1 = 0
Name0 = '' ; 
while  (setmetatable({ [ not_nan_and_nil(not  '') ] = '' ==  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(-0.011719) ] = ''; [ not_nan_and_nil(function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
Name0, Name0['']  = -12.500000, '' ; 
end
) ] = false, '/' }, table_mt))() do
