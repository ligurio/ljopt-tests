...
counter_0 = 0
counter_1 = 0
for Name4 = always_number(10.500000), always_number(''), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = -0.000000,  ... , -2.750000, 4.750000, -0.000031, 2.000456, 0.000000, -2.500000, -2.000000, -400.000000, 10.500000, -1000.000000, 2.000000, Name0:Name0  (setmetatable({  }, table_mt))() ; 
end
; 
for Name4 = always_number(10.500000), always_number(''), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = -0.000000,  ... , -2.750000, 4.750000, -0.000031, 2.000456, 0.000000, -2.500000, -2.000000, -400.000000, 10.500000, -1000.000000, 2.000000, false ; 
end
; 
