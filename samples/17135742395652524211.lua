...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', Name0 = '', [ not_nan_and_nil(false) ] = '', -0.000000,  (setmetatable({  }, table_mt))(), nan, -0.000000, -0.000000, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
Name0 = -0.000237 % (0.000000 or 0.000000) ; 
Name0 = '' ; 
