...
for Name0 = always_number('' * (# '')), always_number(Name0:Name0  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))()  (setmetatable({  }, table_mt))()), always_number(( ... )) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;

end
; 
for Name2 = always_number(-0.000031 * true .. 'getupvalue'), always_number(-0.000050), always_number(-0.000050) do
