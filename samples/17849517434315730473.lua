...
Name0 = '' ; 
if '' then
	elseif  (setmetatable({ Name0 = ''; [ not_nan_and_nil('') ] = ''; }, table_mt))() then
	end
; 
function Name0.Name0.Name0( Name0, Name0, Name0, Name2, Name0, ... )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
function Name0.Name0.Name0( Name0, Name0, Name0, Name0, Name0, ... )
