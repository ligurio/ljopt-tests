...
counter_3 = 0
Name0 = '' ; 
Name0 = (2.100605), 1000.000000, 1000.000000, 1000.000000, true, 1000.000000 ; 
for Name0 = always_number(function ( Name0, ... )
...
until nil; 
while  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() do
...
), always_number(-2.000000), always_number( (setmetatable({ Name0 = 84.000000 }, table_mt))()) do
