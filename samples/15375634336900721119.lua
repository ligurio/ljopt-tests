...
for Name6 = always_number(0.000488), always_number(0.000488) do
...
; 
for Name0 = always_number(4.000130), always_number(''), always_number(-2.000000) do
if counter_6 > 5 then break end
counter_6 = counter_6 + 1;
for Name6 = always_number(Name0), always_number(1000.000000) do
