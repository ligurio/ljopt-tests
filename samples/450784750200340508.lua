...
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number('') do
...
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(''), always_number(Name0) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(Name0), always_number(Name0) do
