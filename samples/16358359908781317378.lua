...
; 
if '' or ( (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({ '' }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))()) == '' then
	end
; 
