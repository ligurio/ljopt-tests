...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(1.945313) ] = Name0:Name0  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(17.447052) ] = Name0, Name0 = '', [ not_nan_and_nil( ... ) ] = '' }, table_mt))() do
