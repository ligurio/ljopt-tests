...
for Name0 = always_number( (setmetatable({ Name0 = '' }, table_mt))()), always_number(true), always_number(-0.000000) do
...
break; 
until ''; 
for Name0 = always_number(2.000000), always_number(( (setmetatable({ Name0 = '' }, table_mt))())), always_number('') do
