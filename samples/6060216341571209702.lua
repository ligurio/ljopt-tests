...
counter_0 = 0
counter_1 = 0
for Name0 = always_number('/'), always_number(not  not  ''), always_number(not  not  Name0) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(not  not  not  ''), always_number(true), always_number(0.000488) do
