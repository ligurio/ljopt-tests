...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(''), always_number(0.000000), always_number(function (  )
...
; 
for end_1 = always_number(function (  )
	if counter_2 > 5 then return end
counter_2 = counter_2 + 1;
end
), always_number(45.000000), always_number(-0.000000) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
Name0 = '' ; 
Name0 = (''),  (setmetatable({  }, table_mt))(), '', '',  (setmetatable({ -0.000000 }, table_mt))() ; 
Name0 =  ...  ; 
end
; 
