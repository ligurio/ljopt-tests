...
counter_0 = 0
Name0 = '' ; 
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] = nil }, table_mt))() .. nil), always_number(''), always_number( (setmetatable({ Name0 = '', Name0 = '' }, table_mt))() .. nil) do
