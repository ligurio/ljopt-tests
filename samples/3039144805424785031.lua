...
counter_0 = 0
Name0 = '' ; 
for Name1 = always_number(0.000000), always_number( (setmetatable({ Name0 = '' }, table_mt))()), always_number(nil) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = 44.000000,  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name0 }, table_mt))() ; 
end
; 
