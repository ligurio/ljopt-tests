...
counter_1 = 0
Name0 = '' ; 
for Name0 = always_number(''), always_number((-1000.000000 + -1000.000000 + -1000.000000 - -1000.000000 * -1000.000000 .. false * 108.750000) .. 0.000000), always_number(0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(0.000000), always_number( (setmetatable({ Name0 }, table_mt))()), always_number(Name0) do
