...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(''), always_number(''), always_number( (setmetatable({ 1000.000000, Name0 = '', -0.000050 * -0.000050 == 0.000000, }, table_mt))()) do
...
until local_1:Name0  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
