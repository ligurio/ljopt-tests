...
; 
for Name0, Name0 in '', 163.449388, '', 163.449388,  (setmetatable({  }, table_mt))(), '', '', -0.003837, true, 163.449388, ''  do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
break; 
end
; 
for Name0, Name0 in '' or 0.000000, 0.000000,  (setmetatable({  }, table_mt))()  do
