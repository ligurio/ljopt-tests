...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(''), always_number(true), always_number(#  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(( (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(('')) ] = '' }, table_mt))())) ] = '' }, table_mt))()) do
