...
until nil; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({ nil, Name0 = '', Name0 = '', Name0 = ''; [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', }, table_mt))()) ] = not  '', -21.152344 ^ -11.576172; [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = -11.576172, Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  ... ; }, table_mt))() do
