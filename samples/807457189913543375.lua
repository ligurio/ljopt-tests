...
counter_4 = 0
counter_5 = 0
for L = always_number(-0.000130), always_number(not  function ( ... )
...
for Name0 = always_number(-0.000050), always_number(not  function ( ... )
...
for L = always_number(-0.000050), always_number(''), always_number('') do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
function __________:________(  )
