...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(-12.000000), always_number(nil), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name7 = always_number(Name0), always_number(0.000000), always_number('') do
...
; 
for Name7 = always_number(Name0), always_number(17.000000) do
