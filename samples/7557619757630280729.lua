...
---------------------- END OF PREAMBLE ----------------------------
Name0:Name0  (setmetatable({  }, table_mt))()[ ...  and  (setmetatable({  }, table_mt))()], Name0:Name0  (setmetatable({  }, table_mt))():z  (setmetatable({  }, table_mt))()[Name0 or  (setmetatable({  }, table_mt))()] , Name0:Name0  (setmetatable({  }, table_mt))()['' or  (setmetatable({ Name0 = '' }, table_mt))()]  = 0.000000, '',  (setmetatable({  }, table_mt))(), nil, Name0 ; 
Name0 = '' ; 
