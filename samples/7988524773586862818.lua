...
; 
Name0 = '' or '',  ... , false, Name0  (setmetatable({ Name0 = ''; }, table_mt))(), -2.750000, 5.500000,  ... ,  ... , Name0  (setmetatable({ Name0 = ''; }, table_mt))(), '', # -2.750000, 0.000000, '', 2.000015, Name0:Name0  (setmetatable({  }, table_mt))() ; 
