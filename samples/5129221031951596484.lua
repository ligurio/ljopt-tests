...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(-108.125000), always_number(1.500000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil('recunro') ] = '', '', '', Name0 = '', ''; '', 416.000000, 0.000000, '' }, table_mt))() do
