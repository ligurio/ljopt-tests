...
until nil; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '',  ... , [ not_nan_and_nil(17.000000) ] =  (setmetatable({  }, table_mt))() }, table_mt))()) ] = '',  ... , [ not_nan_and_nil(17.000000) ] =  (setmetatable({  }, table_mt))() }, table_mt))() do
