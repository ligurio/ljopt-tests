...
counter_4 = 0
counter_5 = 0
for Name6 = always_number('..'), always_number(Name0), always_number((nil)) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name6 = always_number(''), always_number(''), always_number(Name0) do
...
for Name0 = always_number(''), always_number( (setmetatable({ [ not_nan_and_nil('..') ] =  (setmetatable({  }, table_mt))() }, table_mt))()), always_number('') do
