...
; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] = 0.000000,  (setmetatable({ [ not_nan_and_nil(Name0) ] = 0.000000,  ... , [ not_nan_and_nil(Name0) ] = 0.000000 }, table_mt))(), [ not_nan_and_nil(Name0) ] = 0.000000 }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] = 0.000000, '' }, table_mt))() do
