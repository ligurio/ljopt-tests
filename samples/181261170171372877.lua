...
; 
for Name0 = always_number(2.000000), always_number(0.000000), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name1  =  (setmetatable({ [ not_nan_and_nil(Name1) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  (setmetatable({  }, table_mt))() }, table_mt))(),  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))(), Name0 }, table_mt))(), Name0 ; 
end
; 
