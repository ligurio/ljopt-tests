...
Name0 = '' ; 
for Name0 = always_number(true), always_number(0.000000), always_number(-0.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
if  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() then
	end
; 
end
; 
