...
do
Name0 = '' ; 
for Name2 = always_number(# ''), always_number(-1000.000000), always_number(-1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = '' ; 
for Name8 = always_number(not  ''), always_number(-1000.000000), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name2 = always_number(# nil), always_number(-1000.000000), always_number(-1000.000000) do
...
; 
for Name8 = always_number(- ''), always_number(-1000.000000), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name2 = always_number(# ''), always_number(0.000000), always_number(-1000.000000) do
