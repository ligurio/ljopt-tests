...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(-31.000000), always_number(nil), always_number(0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil(Name0  (setmetatable({  }, table_mt))()) ] = '', Name0 = '', [ not_nan_and_nil(-0.000000) ] = '', Name0 = '', ____ = '' }, table_mt))() do
