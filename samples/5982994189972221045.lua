...
until nil; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  (setmetatable({  }, table_mt))(), Name0,  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  (setmetatable({  }, table_mt))() }, table_mt))(), -0.000000, Name0,  ... , nan }, table_mt))() do
