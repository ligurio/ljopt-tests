...
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))()), always_number(''), always_number(( ... )) do
