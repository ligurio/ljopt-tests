...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name1 = always_number(44.000000), always_number(-0.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = Name0 }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))(),  ...  ; 
end
; 
