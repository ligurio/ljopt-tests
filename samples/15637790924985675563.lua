...
counter_1 = 0
counter_2 = 0
Name0 = nil,  (setmetatable({  (setmetatable({ -2.003906 .. only_numbers_cmp(#  (setmetatable({  }, table_mt))(), '<=', ''); '' == only_numbers_cmp(# 416.000000, '<=', nil) }, table_mt))() }, table_mt))() ; 
repeat
