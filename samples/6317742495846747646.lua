...
counter_0 = 0
local Name0; 
for Name2 = always_number(44.000000), always_number(44.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ -0.000000, -0.000000, -0.000000, -0.000000, -0.000000, -0.000000, Name0 = '', -0.000000 }, table_mt))(), '' ; 
end
; 
