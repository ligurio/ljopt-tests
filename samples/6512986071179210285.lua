...
Name0:os_difftime  (setmetatable({  }, table_mt))(); 
Name0 =  (setmetatable({ Name0 = ''; [ not_nan_and_nil('' ^ -2.003907 ^ '') ] = Name0[-0.983081] }, table_mt))() ; 
local Name0 = '\001\000\000\000\000' ; 
for ________, Name0 in false  do
