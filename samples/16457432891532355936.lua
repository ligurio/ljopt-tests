...
counter_1 = 0
Name0 = # not  not  '' ; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))() }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))() }, table_mt))() }, table_mt))() do
