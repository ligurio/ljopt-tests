...
counter_1 = 0
counter_2 = 0
for atan, LUA_INIT, _, Name7, LUA_INIT, LUA_INIT in function ( Name0, LUA_INIT, _, Name7, LUA_INIT, LUA_INIT, LUA_INIT, LUA_INIT, ... )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
return  (setmetatable({  }, table_mt))(), function ( Name0 )
