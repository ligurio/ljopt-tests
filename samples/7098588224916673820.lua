...
counter_3 = 0
Name0 = '' ; 
for Name0 = always_number(''), always_number(0.000000), always_number(':\000\000\000\z06') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(false), always_number( ... ) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
while  (setmetatable({ ':\000call\000\z06', ''; [ not_nan_and_nil('') ] = '' }, table_mt))() do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
Name0, Name0  = only_numbers_cmp(':\000\000\000\z06', '>', ''), '', '' ; 
end
; 
end
; 
Name0 = '' ; 
for Name0 = always_number(''), always_number(0.000000), always_number(':\000call\000\z06') do
