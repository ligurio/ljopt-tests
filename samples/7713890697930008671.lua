...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name4 = always_number(false), always_number(-0.000050 * 1000.000000 * -0.000050 * -0.000050 * 1000.000000 * -0.000050 * false .. not  false * false), always_number(not  false) do
