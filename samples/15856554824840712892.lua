...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ [ not_nan_and_nil(false) ] = '', '', 'L6\001\000000\000\0', Name0 = '' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil('') ] = '', 'L6\001\000000\000\0', Name0 = '', Name0 = '', Name0 = '' }, table_mt))() do
