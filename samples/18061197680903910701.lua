...
counter_4 = 0
counter_5 = 0
for Name0 = always_number(''), always_number(nil), always_number('') do
...
; 
for Name0 = always_number(''), always_number('end') do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name3 = always_number(''), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name8 = always_number(''), always_number('') do
