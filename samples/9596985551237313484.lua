...
counter_2 = 0
Name0 = -2.750000 ; 
for LUA_PATH_5_4 = always_number(-2.750000), always_number(false), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(''), always_number(-0.000000), always_number(only_numbers_cmp( ... , '<', '')) do
...
; 
for Name4 = always_number(Name0), always_number(Name0), always_number(Name0) do
