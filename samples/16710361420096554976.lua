...
Name0, Name0 , Name0 , Name0[Name0] , Name0.next  = '' ; 
end
; 
Name0 = '' ; 
for ________ in Name0.next  do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
Name0, ___________________ , Name0 'H'  (setmetatable({  }, table_mt))().Name , Name0 , Name0[Name0] , Name0  = '' ; 
for ________, Name0 in Name0  do
