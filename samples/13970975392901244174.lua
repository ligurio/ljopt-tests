...
until nil; 
while  (setmetatable({ _ = -0.004500 % -0.000031,  (setmetatable({  }, table_mt))(); nan, [ not_nan_and_nil( (setmetatable({ Name0 = '', [ not_nan_and_nil( (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = '' }, table_mt))()) ] = true }, table_mt))()) ] = true, Name0 = ')'; nan, nil }, table_mt))() do
