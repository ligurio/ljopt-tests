...
while  (setmetatable({ [ not_nan_and_nil(-415.500000) ] = '', [ not_nan_and_nil(1.500000) ] =  (setmetatable({  }, table_mt))(), Name0 = '' }, table_mt))() do
...
Name0 = '' ; 
until nil; 
for Name0 = always_number(0.000000), always_number(-415.500000), always_number(1.500000) do
