...
counter_4 = 0
counter_5 = 0
for Name6 = always_number(-0.000000), always_number(''), always_number(true) do
...
for Name0 = always_number((-5.000000 .. '99999999999999999999')), always_number(0.000000), always_number(nil) do
...
; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name0 = always_number((-5.000000 .. 'e3333')), always_number(0.000000), always_number(-0.000000) do
