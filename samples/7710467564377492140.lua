...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(not  false), always_number(not  not  ''), always_number(not  not  '') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(not  not  ''), always_number(not  not  ''), always_number(not  not  '') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name4 = always_number(not  not  ''), always_number(''), always_number(not  not  '') do
