...
---------------------- END OF PREAMBLE ----------------------------
local callunr = '', false, 0.000000, 0.000000 .. '', Name0:Name0 '%', -0.000031, 0.000000, '\\', -2.500031, -2.000000, 8.500000,  ... ,  (setmetatable({  }, table_mt))(), ( (setmetatable({  }, table_mt))()),  ... , 4.000000, Name0:Name0  (setmetatable({  }, table_mt))() ; 
Name0 = '' ; 
