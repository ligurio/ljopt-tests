...
---------------------- END OF PREAMBLE ----------------------------
Name0 =  (setmetatable({  }, table_mt))(), '', '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '', Name0,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
