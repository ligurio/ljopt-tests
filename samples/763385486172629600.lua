...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name1 = always_number(0.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({  }, table_mt))(),  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))() }, table_mt))(), Name0 =  (setmetatable({  }, table_mt))() }, table_mt))(), Name0,  ...  ; 
