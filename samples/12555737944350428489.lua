...
Name0 =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), not  Name0:Name0  (setmetatable({  }, table_mt))() ; 
end
; 
