...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number( (setmetatable({ -1000.000000 - 0.000000 }, table_mt))()), always_number(0.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
if  (setmetatable({ (0.000000 and -1000.000000 + -1000.000000 * -1000.000000 .. '0.3E0') - 0.000000 }, table_mt))() then
	end
; 
end
; 
