...
Name1 = Name0 ; 
for Name1 = always_number(0.000000), always_number(Name0), always_number(Name0) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
if  (setmetatable({ [ not_nan_and_nil( (setmetatable({ -0.000000 }, table_mt))()) ] = '', Name0 = '' }, table_mt))() then
	end
; 
break; 
end
