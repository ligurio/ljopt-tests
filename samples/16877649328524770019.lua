...
counter_6 = 0
counter_7 = 0
for Name1 = always_number(''), always_number(function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0:Name0  (setmetatable({  }, table_mt))(); 
for ____________________ = always_number(''), always_number(-1000.000000 + -1000.000000 * -1000.000000), always_number(function (  )
...
; 
for load = always_number(''), always_number(function (  )
	if counter_4 > 5 then return end
counter_4 = counter_4 + 1;
end
), always_number(function (  )
...
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
for Name2 = always_number(''), always_number('') do
