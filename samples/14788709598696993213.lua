...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name3, Name3 in  (setmetatable({  (setmetatable({  ... ,  (setmetatable({  }, table_mt))(), Name0 = '', nil, Name0 = '', '', Name0 = '' }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  ... , '', nil, Name0 = '' }, table_mt))(), true, false  do
