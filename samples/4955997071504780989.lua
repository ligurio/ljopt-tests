...
until ''; 
Name0 =  ... , '', true,  (setmetatable({ [ not_nan_and_nil(Name0 - '') ] = ''; Name0 = '', Name0 = false, ____________________ = '' }, table_mt))(), nil,  (setmetatable({  }, table_mt))(), true, '', true, '' or '', true,  (setmetatable({  }, table_mt))(), true,  (setmetatable({  }, table_mt))(), true, true,  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
