...
Name0 = '' ; 
until ''; 
for _ = always_number(-468.750000), always_number(-468.750000), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number('' == ''), always_number(-468.750000) do
