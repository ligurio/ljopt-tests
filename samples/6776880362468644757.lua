...
; 
for Name4 = always_number(17.187500), always_number(0.000000), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name1  =  (setmetatable({ Name0, Name0 }, table_mt))(),  (setmetatable({ Name0, Name0, Name0, Name0, Name0 }, table_mt))(), '' ; 
end
; 
