...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number( (setmetatable({ Name0 =  (setmetatable({ Name0 =  (setmetatable({  }, table_mt))() or Name0 or '' }, table_mt))() or  (setmetatable({  }, table_mt))() or Name0 or '' }, table_mt))() or ''), always_number('') do
