...
; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  (setmetatable({ Name7 = '' }, table_mt))() }, table_mt))() == '') ] = '', [ not_nan_and_nil(-0.003837) ] = '', Name0 = '', [ not_nan_and_nil(-0.003837) ] = '', Name0 = ''; }, table_mt))() do
