...
Name0 = '' ; 
Name0 = '' ; 
Name0, Name0 , Name0  = function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
return true, '', '', '', '6', #  (setmetatable({ [ not_nan_and_nil('') ] = '',  nil, }, table_mt))()  ; 
end
 ; 
Name0, Name0 , Name0:Name0  (setmetatable({  }, table_mt))().Name  = '', false, '6', 0.000000, '', Name0 ('', '', '', Name0  (setmetatable({  }, table_mt))() ) ; 
