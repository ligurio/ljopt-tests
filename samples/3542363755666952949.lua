...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(''), always_number( (setmetatable({ '', [ not_nan_and_nil('' or '') ] = '' }, table_mt))()), always_number(Name0:Name0 (0.000000, '' )  (setmetatable({  }, table_mt))()) do
...
for Name0 = always_number(''), always_number( (setmetatable({ -0.000000 }, table_mt))()), always_number(Name0) do
