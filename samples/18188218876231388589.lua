...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(''), always_number(true), always_number(true) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil('') ] = '', Name0 = '', false_1 = '', 0.000000, }, table_mt))()), always_number(''), always_number(416.000000) do
