...
---------------------- END OF PREAMBLE ----------------------------
local Name2 =  ... , '', true,  (setmetatable({ [ not_nan_and_nil(Name0 - '') ] = '', Name0 = '', _ = false; Name2 = ''; }, table_mt))(), '',  (setmetatable({  }, table_mt))(), true, '', nil, '', true, '', true,  (setmetatable({  }, table_mt))(), true, true, '', Name0:Name0  (setmetatable({  }, table_mt))() ; 
