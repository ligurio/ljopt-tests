...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(-2.000000), always_number( (setmetatable({  }, table_mt))()), always_number('j') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(''), always_number('jit.opt.s'), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(''), always_number('jit.opt.s'), always_number(function (  )
