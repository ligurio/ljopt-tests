...
; 
Name0 = '' ; 
for z_ in  (setmetatable({ [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil(-1000.000000) ] =  (setmetatable({  }, table_mt))(),  ... , }, table_mt))()) ] = -1000.000000, Name0 = '', Name0 = true, }, table_mt))()  do
