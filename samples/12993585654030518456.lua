...
counter_0 = 0
counter_1 = 0
for debug_setupvalue = always_number(1000.000000 ^ -48.000000), always_number(''), always_number( (setmetatable({ Name0 = '', Name0 = '' }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil('') ] = nil }, table_mt))() do
