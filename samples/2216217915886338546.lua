...
until nil; 
while  (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil(-0.000000) ] = '_[_eq' }, table_mt))()) ] = '__eq' }, table_mt))() do
