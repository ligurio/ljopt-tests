...
Name0 = nil,  (setmetatable({  }, table_mt))(), 1000.000000,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0, only_numbers_cmp('', '<', '') ~= '' ; 
end
; 
Name0 = '' ; 
