...
counter_0 = 0
counter_1 = 0
for ____ = always_number(''), always_number(2.005118), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil(true) ] = Name0 }, table_mt))() ; 
end
; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name7 = always_number(2.005118), always_number(1.000000), always_number(-0.000000) do
