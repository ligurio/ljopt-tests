...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ Name0 = '', -0.000206, Name0 = '', Name0 = '', Name0 = '', [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] = '', Name0 = '', [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] = '' }, table_mt))() do
