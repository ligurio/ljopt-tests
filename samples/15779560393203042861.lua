...
counter_5 = 0
counter_6 = 0
for Name0 = always_number(-0.000000), always_number(0.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(Name0), always_number(0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(2.000000), always_number(2.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name0 = always_number(Name0), always_number(-0.000000), always_number(-1000.000000) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name0 = always_number(Name0), always_number(2.000000), always_number('') do
...
; 
for Name0 = always_number(Name0), always_number(0.507690) do
