...
counter_3 = 0
counter_4 = 0
for Name8 = always_number(0.000000), always_number(-468.750000), always_number(false) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for _ = always_number(-468.753906), always_number(1.500000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(-468.750000), always_number(function (  )
...
; 
for _ = always_number(-468.750000), always_number('') do
