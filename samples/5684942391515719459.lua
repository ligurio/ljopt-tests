...
counter_6 = 0
counter_7 = 0
for Name0 = always_number(-468.750000), always_number(''), always_number(-468.750000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number('\allunr'), always_number(0.000000), always_number('') do
...
; 
for Name0 = always_number(-468.750000), always_number(-468.750000), always_number(0.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number(''), always_number(''), always_number(-468.750000) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for Name0 = always_number('\allunr'), always_number('\allunr'), always_number('') do
...
; 
Name0 = '' ; 
for Name0 = always_number(0.000000), always_number(-468.750000), always_number('\allunr') do
...
; 
Name0 = '' ; 
for Name0 = always_number(-468.750000), always_number(-468.750000) do
