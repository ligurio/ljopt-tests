...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(# ''), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(''), always_number(Name0) do
...
; 
Name0 = '' ; 
Name0, Name0  =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), 400.500000,  (setmetatable({  }, table_mt))(), 400.500000,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({ Name0 = '', }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
