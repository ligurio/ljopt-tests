...
while  (setmetatable({ Name0 - 108.750000 }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = '' ; 
Name0, Name3 , Name0 , Name0:Name0  (setmetatable({  }, table_mt))()[Name0:Name0  (setmetatable({  }, table_mt))()]  = ('\''), Name0:Name0  (setmetatable({  }, table_mt))(), '' ; 
Name0 = '' ; 
Name0 = '' ; 
end
; 
