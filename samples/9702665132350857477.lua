...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(0.000000), always_number('44444444444444444444') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(not  ''), always_number(-1000.000000) do
...
while '44444444444444444444' do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
until '' ==  (setmetatable({ '' }, table_mt))(); 
for Name0 = always_number(-1000.000000), always_number(4.000000) do
