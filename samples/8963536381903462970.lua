...
for Name6 = always_number(44.062500), always_number(''), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
Name0 = '' ; 
for Name6 = always_number(true), always_number(0.000000), always_number(-0.000000) do
...
for Name6 = always_number(2.000000), always_number(0.000000), always_number(-0.000000) do
