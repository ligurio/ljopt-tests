...
; 
Name0, Name0  = '',  (setmetatable({  }, table_mt))(), '', 400.500000,  (setmetatable({  }, table_mt))(), 400.500000,  (setmetatable({  }, table_mt))(), true, '', '',  (setmetatable({  }, table_mt))(), '',  (setmetatable({ Name0 = '', }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
