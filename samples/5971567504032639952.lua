...
while -0.000050 / -0.000050 / -0.000050 / true do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for next = always_number(''), always_number(-0.000050) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
Name0:Name0  (setmetatable({  }, table_mt))(); 
end
; 
for Name0 = always_number(163.449388), always_number(-0.000000), always_number(-0.000000) do
