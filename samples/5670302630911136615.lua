...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(-2.000000), always_number(true) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name0 = '', Name8 = '', [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() }, table_mt))()), always_number(5.000000), always_number(Name0) do
