...
counter_6 = 0
counter_7 = 0
for Name0 = always_number(-1000.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(''), always_number(-1000.000000), always_number(Name0) do
...
for Name0 = always_number(''), always_number(-464.000000), always_number(Name0) do
...
; 
for Name0 = always_number(''), always_number(-101.000000), always_number(Name0) do
