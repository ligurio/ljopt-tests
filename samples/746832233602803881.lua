...
; 
for Name8 = always_number(# 416.000000 * ''), always_number(1.500000), always_number(-1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name8 = always_number(416.000000), always_number(-1000.000000), always_number(true / 0.000000) do
