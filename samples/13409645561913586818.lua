...
; 
for Name0 = always_number(''), always_number(true) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
local ffffffffffffffffffff; 
for Name0 = always_number(''), always_number('') do
...
; 
for Name0 = always_number(''), always_number(false) do
...
; 
for Name9 = always_number(''), always_number('') do
if counter_7 > 5 then break end
counter_7 = counter_7 + 1;
end
; 
local Name0; 
for Name0 = always_number(''), always_number(''), always_number( (setmetatable({ Name0 = '', Name0 = '' }, table_mt))()) do
...
; 
for Name0 = always_number( (setmetatable({ Name0 = '', Name0 = '' }, table_mt))()), always_number(''), always_number(-0.000000) do
