...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
('{{{{{{{{{{{{{{{{{{{{' or  (setmetatable({  }, table_mt))()):Name0  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
Name0 = '' ; 
Name0 = nil, 4.000000, 1.500000, '', -2.750000, 5.500000, 5.000000, function ( Name0 )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
, 2.500000, -2.000000, -412.750000, true, 4.000023, 2.000000, ('{{{{{{{{{{{{{{{{{{{{' or  (setmetatable({  }, table_mt))()) == Name0 ; 
