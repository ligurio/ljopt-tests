...
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  ... , [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  ... , [ not_nan_and_nil(Name0) ] = '' }, table_mt))() }, table_mt))()), always_number(-2.000000) do
