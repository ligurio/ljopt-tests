...
; 
for Name2 = always_number(''), always_number(1.500000), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name1 =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name0 = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name0 = '' }, table_mt))() ; 
end
; 
