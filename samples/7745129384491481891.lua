...
counter_6 = 0
counter_7 = 0
for Name0 = always_number(2.000000), always_number(''), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(0.000000), always_number(nil) do
...
for Name0 = always_number(0.000000), always_number(2.000000) do
if counter_6 > 5 then break end
counter_6 = counter_6 + 1;
for Name0 = always_number(0.000000), always_number(1000.000000) do
