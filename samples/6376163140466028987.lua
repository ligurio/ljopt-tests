...
local Name0; 
for Name0 = always_number(''), always_number(1.500000), always_number((-0.005722 .. '') ^ '') do
...
; 
for ____________________ = always_number(1.500000), always_number(44.000000), always_number(1.500000) do
