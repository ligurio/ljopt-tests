...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name1 = always_number(''), always_number(-0.226562), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil('') ] = Name0, [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))(), [ not_nan_and_nil('') ] =  ... , [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))() ; 
end
; 
