...
---------------------- END OF PREAMBLE ----------------------------
local io_flush, Name0, io_flush = '', '', '',  (setmetatable({ 4.000000, 2.066895 ^ '' }, table_mt))(), nil, -0.000046, 10.500000, # '', not  '', 927.874998 ^ -1000.000000, -2.500031, '',  (setmetatable({ [ not_nan_and_nil('') ] =  ...  }, table_mt))(),  ... , -1000.000000, 1000.000000,  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))(), '' == '' ; 
Name0 = '' ; 
