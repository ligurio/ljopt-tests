...
counter_0 = 0
counter_1 = 0
(nil)  (setmetatable({  }, table_mt))()  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
Name0 = '' ; 
repeat
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(''), always_number(Name0:Name0  (setmetatable({  }, table_mt))()) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
Name0, Name0[''] , Name0 , Name2 , Name0.________ , Name0[''] , Name1  =  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
until Name0:Name0  (setmetatable({  }, table_mt))(); 
