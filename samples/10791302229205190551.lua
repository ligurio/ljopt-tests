...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(true) ] = nan, nan, Name0 = '',  ... , -0.000000, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = not   (setmetatable({ Name0 = '', Name0 = ''; }, table_mt))(), nan, Name0 = '', nil, '' }, table_mt))() do
