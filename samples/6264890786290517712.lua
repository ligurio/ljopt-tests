...
counter_0 = 0
Name0 = '' ; 
for Name0 in  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(), '',  (setmetatable({ Name0 = '' }, table_mt))(), ''  do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0, Name0 , Name0  =  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))(),  (setmetatable({  }, table_mt))(), true,  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(), '' ; 
