...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil(true) ] =  (setmetatable({  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil(2.000000) ] =  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))(), [ not_nan_and_nil(not  '') ] = nil }, table_mt))() do
