...
if '' then
	local Name0; 
for Name0 = always_number( (setmetatable({  }, table_mt))()), always_number(''), always_number(108.750000 ^ 108.750000 ^ -21.152344 ^ -11.576172) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
for Name0 = always_number(-21.152344 ^ -11.576172), always_number(Name0), always_number(108.750000) do
