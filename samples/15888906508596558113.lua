...
while  (setmetatable({ [ not_nan_and_nil(true) ] = '', [ not_nan_and_nil(-0.242187) ] = function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
return; 
end
, [ not_nan_and_nil(5.000000) ] =  ... , Name0 = '' }, table_mt))() do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
until ''; 
Name0.Name = '' or Name0:Name0  (setmetatable({  }, table_mt))() ; 
