...
; 
for Name0, Name0 in not  (only_numbers_cmp(Name0:Name0  (setmetatable({  }, table_mt))(), '>=', 3.000000)), # not  0.000000, function (  )
...
; 
for Name4 = always_number(''), always_number(3.000000) do
