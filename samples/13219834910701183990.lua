...
do
Name0 = '' ; 
for Name0 = always_number(''), always_number(#  (setmetatable({  }, table_mt))() % 0.000000 .. true == nil), always_number(-0.000000) do
...
; 
for Name2 = always_number(false), always_number(-1000.000000), always_number(-1000.000000) do
