...
counter_1 = 0
counter_2 = 0
for Name5 = always_number(0.000000), always_number(0.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
for Name1 = always_number(''), always_number(''), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 =  (setmetatable({  }, table_mt))(),  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))(), Name1 =  (setmetatable({  }, table_mt))() }, table_mt))(),  ...  ; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
end
; 
while  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))() do
