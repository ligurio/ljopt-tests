...
---------------------- END OF PREAMBLE ----------------------------
local Name2 =  ... , '', true,  (setmetatable({ [ not_nan_and_nil(0.000000) ] = false; Name0 = '', _ = false; Name0 = ''; ____________________ = ''; }, table_mt))(), 'LLLLLLLLLLLLLLLLLLL',  (setmetatable({ Name0 = '', }, table_mt))(), true, '', true, '', true, '', true,  (setmetatable({  }, table_mt))(), true, true, '', Name0:Name0  (setmetatable({  }, table_mt))() ; 
