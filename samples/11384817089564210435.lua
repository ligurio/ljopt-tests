...
until  (setmetatable({ Name0 = ''; Name0 = '' }, table_mt))(); 
while  (setmetatable({ Name0 = 'os.tmpname' == '', [ not_nan_and_nil(415.945312) ] = '\001\005', [ not_nan_and_nil( ... ) ] =  ... , Name0 = ''; }, table_mt))() do
