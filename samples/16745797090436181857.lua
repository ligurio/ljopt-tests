...
; 
while  (setmetatable({ [ not_nan_and_nil(false) ] = '', [ not_nan_and_nil(Name0) ] = ''; [ not_nan_and_nil(false) ] =  (setmetatable({ [ not_nan_and_nil(false) ] = '', [ not_nan_and_nil(false) ] = '', Name0 = '' }, table_mt))() }, table_mt))() do
