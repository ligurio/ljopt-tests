...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ nan, nil,  (setmetatable({  (setmetatable({ Name0, Name0 = 0.000000 }, table_mt))(), }, table_mt))(), [ not_nan_and_nil( (setmetatable({  (setmetatable({ Name0 = ''; Name0 = '' }, table_mt))() }, table_mt))()) ] = '' }, table_mt))() do
