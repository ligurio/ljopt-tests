...
counter_6 = 0
counter_7 = 0
while  (setmetatable({ [ not_nan_and_nil(-415.500000) ] = ''; Name0 = '', 1.500000 }, table_mt))() do
...
while  (setmetatable({ [ not_nan_and_nil(-415.500000) ] = '', 1.500000 }, table_mt))() do
...
while  (setmetatable({ [ not_nan_and_nil('') ] = '', 1.500000 }, table_mt))() do
