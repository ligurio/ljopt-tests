...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0:infile_setvbufstunro  (setmetatable({  }, table_mt))(); 
repeat
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0.____________________, ('infile:setvbufstunro')[0.000000] , Name0 , Name0.Name , ('infile:setvbufstunro')[0.000000] , ( (setmetatable({  }, table_mt))())[0.000000] , ('')[0.000000] , Name0 , infile_setvbufstunro  = true ; 
until  ... ; 
