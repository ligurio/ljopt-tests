...
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(-0.000000) ] = 48.000000 }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(#  (setmetatable({  }, table_mt))()) ] = 2.000002, [ not_nan_and_nil(-0.000000) ] =  (setmetatable({  }, table_mt))() }, table_mt))() do
