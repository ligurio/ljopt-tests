...
---------------------- END OF PREAMBLE ----------------------------
local Name0 = true,  (setmetatable({ [ not_nan_and_nil(-1000.000000 * -1000.000000 * -1000.000000) ] = '', [ not_nan_and_nil(-1000.000000 * -1000.000000 * '') ] = 0.000000, Name0 = -3.000000 }, table_mt))() ; 
Name0 = '' ; 
Name0 = '' ; 
