...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0 =  (setmetatable({ true, nil }, table_mt))(),  (setmetatable({  }, table_mt))() ; 
while '' do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil(Name0) ] =  ... , [ not_nan_and_nil(Name0) ] = Name0, }, table_mt))(),  (setmetatable({  }, table_mt))() ; 
end
; 
