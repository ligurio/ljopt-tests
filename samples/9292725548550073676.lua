...
counter_1 = 0
counter_2 = 0
while  (setmetatable({ (-0.000050 / 1000.000000 / -0.000050)  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(-0.003837) ] =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', }, table_mt))(); Name0 = '', }, table_mt))() do
