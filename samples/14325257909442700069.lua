...
counter_1 = 0
Name0 = '' ; 
for ___io_input7_325 = always_number(Name0.________________), always_number(''), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
for Name0 = always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number(2.000000), always_number('') do
