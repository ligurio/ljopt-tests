...
---------------------- END OF PREAMBLE ----------------------------
jlogjjjjjjjjjjDjjjj =  (setmetatable({ Name0 = '', Name0 = '', Name0 = Name0:Name0  (setmetatable({  }, table_mt))(), [ not_nan_and_nil( ... ) ] = ''; nil, Name4 = '' }, table_mt))(),  (setmetatable({ '', ''; 2.000008; Name0 = '', nil, ''; }, table_mt))(), '' ; 
Name0 = '' ; 
