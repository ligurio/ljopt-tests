...
; 
for Name0 = always_number(true), always_number(''), always_number( (setmetatable({ nan, [ not_nan_and_nil(true) ] = nan, Name4 = '', [ not_nan_and_nil(nil) ] = nil; Name0 = '' }, table_mt))()) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
function cccccccccccccccccccc(  )
