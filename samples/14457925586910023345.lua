...
for Name0 = always_number((0.000000 or  ... ) % (function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
)), always_number(''), always_number(not  '') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
Name0 = '' ; 
for Name0 = always_number((0.000000 or  ... ) % ((0.000000 or  ... ) % (function (  )
	if counter_2 > 5 then return end
counter_2 = counter_2 + 1;
end
))), always_number(''), always_number(false) do
