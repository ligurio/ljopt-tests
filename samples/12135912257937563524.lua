...
counter_1 = 0
counter_2 = 0
for os_date = always_number(# ''), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(not  ''), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number('os.date'), always_number(''), always_number(# '') do
...
; 
Name0 = '' ; 
Name0, Name0  =  (setmetatable({  }, table_mt))(), nil,  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] = true }, table_mt))(), 400.500000,  (setmetatable({  }, table_mt))(), 0.000000,  (setmetatable({  }, table_mt))(),  ... , '',  (setmetatable({  }, table_mt))(), '', '', false,  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
