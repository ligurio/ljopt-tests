...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(4.000000), always_number(-38.000000), always_number(-2.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(4.000000), always_number(-2.000000), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(4.000000), always_number(-2.015645), always_number(Name0) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number(4.000000), always_number(''), always_number(Name0) do
