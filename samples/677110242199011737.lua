...
Name0, Name4  =  (setmetatable({ [ not_nan_and_nil( (setmetatable({ 'io.write' }, table_mt))()) ] = # 34.000000 .. true + true }, table_mt))(),  (setmetatable({ Name0 = '',  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))(), true ; 
until true; 
