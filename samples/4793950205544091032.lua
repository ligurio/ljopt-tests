...
counter_0 = 0
local Name0; 
for Name4 = always_number(''), always_number(9.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil(true) ] = -0.000000, [ not_nan_and_nil('') ] = -0.000000, Name0 = '', -0.000000, -0.000000, -0.000000, -0.000000, -0.000000 }, table_mt))() ; 
end
; 
