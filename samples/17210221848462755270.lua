...
; 
Name0, Name0  = '',  (setmetatable({  }, table_mt))(), '', 400.500000, 400.500000, 400.500000, 0.000000, true, true,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '', '',  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
