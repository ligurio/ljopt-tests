...
return  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))()  ; 
end
; 
local function Name0 (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
return  (setmetatable({  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))(),  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))()  ; 
end
; 
