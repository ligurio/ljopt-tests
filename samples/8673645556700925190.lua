...
---------------------- END OF PREAMBLE ----------------------------
Name0  (setmetatable({  }, table_mt))()['' or  (setmetatable({ Name0 = '' }, table_mt))()], Name0 , Name0:Name0  (setmetatable({  }, table_mt))()['' or  (setmetatable({ Name0 = '' }, table_mt))()]  = 0.000000, true, '', nil,  (setmetatable({  }, table_mt))() ; 
