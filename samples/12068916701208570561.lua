...
counter_1 = 0
counter_2 = 0
for Name4 = always_number(''), always_number(-468.750000), always_number(-822.500000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
for Name4 = always_number(''), always_number(-822.500000), always_number(-822.500000) do
