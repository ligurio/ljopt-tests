...
counter_3 = 0
counter_4 = 0
for Name0 = always_number('' == ',&Xb\bbbbbbbbbbbbbbb'), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while '' do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for _ = always_number(-26.000000), always_number('') do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number(',&Xb\bbbbbbbbbbbbbbb' == ',&Xb\bbbbbbbbbbbbbbb'), always_number('') do
