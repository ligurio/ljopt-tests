...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(''), always_number(-2.000000), always_number(-2.004028) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0[Name0][Name0][Name0][Name0]  (setmetatable({  }, table_mt))(); 
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0[Name0][''][Name0][Name0]  (setmetatable({  }, table_mt))(); 
end
; 
