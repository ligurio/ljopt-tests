...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(''), always_number(-2.500000), always_number(-2.500000) do
...
for Name0 = always_number(''), always_number(-2.500000), always_number('') do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number( (setmetatable({ -2.500000 }, table_mt))()), always_number('') do
