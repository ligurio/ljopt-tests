...
counter_5 = 0
counter_6 = 0
for U = always_number(-0.000000), always_number(0.000000), always_number(-0.000000) do
...
; 
for U = always_number(Name0), always_number(false), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name0 = always_number(''), always_number(0.000000) do
