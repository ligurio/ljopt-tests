...
counter_4 = 0
counter_5 = 0
for Name0 = always_number(-2.001953), always_number(''), always_number( (setmetatable({ Name0 = ''; }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(nil), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(-2.171876), always_number(Name0) do
...
; 
for Name0 = always_number(-2.500000), always_number(''), always_number( (setmetatable({ Name0 = ''; }, table_mt))()) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for Name0 = always_number( (setmetatable({ Name0 = '' }, table_mt))()), always_number('') do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
end
; 
for Name0 = always_number(not  ''), always_number(Name0) do
