...
counter_2 = 0
Name0 = '' ; 
while not   (setmetatable({ Name0:Name0  (setmetatable({  }, table_mt))(), }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 in 'debug.getregistry', false_1:Name0  (setmetatable({  }, table_mt))()  do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = '' ; 
end
; 
while  (setmetatable({ ________ = '', }, table_mt))() do
