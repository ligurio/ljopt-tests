...
for Name6 = always_number(''), always_number(Name0), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = nil,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0, '' == '' ; 
end
; 
end
; 
