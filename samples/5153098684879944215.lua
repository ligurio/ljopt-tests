...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name4 = always_number( (setmetatable({ nil, '' or  ... , '', [ not_nan_and_nil('') ] = true; '', [ not_nan_and_nil('') ] =  (setmetatable({  }, table_mt))(), nil, nil, nil, '', nil, nil, nil; }, table_mt))()), always_number(''), always_number(not  '') do
