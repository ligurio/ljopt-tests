...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil(0.000000) ] = '', [ not_nan_and_nil(true) ] = nil, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = nil, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = - '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil( ... ) ] = '' }, table_mt))() do
