...
---------------------- END OF PREAMBLE ----------------------------
(only_numbers_cmp('', '<', '')).Name, Name0:Name0  (setmetatable({  }, table_mt))().Name  = only_numbers_cmp('', '<', only_numbers_cmp('', '>', '')), '' ; 
(only_numbers_cmp(only_numbers_cmp('', '<', only_numbers_cmp('', '>', '')), '<', '')).Name = '', only_numbers_cmp('', '<', only_numbers_cmp('', '>', only_numbers_cmp('', '<=', ''))), '' ; 
