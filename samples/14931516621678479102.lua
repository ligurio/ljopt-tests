...
Name0 = '' ; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
while  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(true) ] = -0.000000, [ not_nan_and_nil(Name0) ] = '' }, table_mt))() do
