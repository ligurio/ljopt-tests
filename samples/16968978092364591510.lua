...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
if only_numbers_cmp('' == not  nil, '>', only_numbers_cmp(not  '', '>', true)) then
	end
; 
for Name7 = always_number(''), always_number(''), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0, Name0  = '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(), Name0,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), ( (setmetatable({  }, table_mt))()) ; 
end
; 
if only_numbers_cmp(0.000000, '>', 0.000000) then
	end
; 
