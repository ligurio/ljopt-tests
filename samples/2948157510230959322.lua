...
) and  (setmetatable({  }, table_mt))()], Name0:Name0  (setmetatable({  }, table_mt))()[Name0 or  (setmetatable({  }, table_mt))()] , Name0:Name0  (setmetatable({  }, table_mt))()['' or  (setmetatable({  }, table_mt))()]  = '' ; 
end
; 
