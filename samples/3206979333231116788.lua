...
until nil; 
while  (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil(true) ] = -0.000000 }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil(true) ] = -0.000000, [ not_nan_and_nil(false) ] = -0.000000 }, table_mt))() do
