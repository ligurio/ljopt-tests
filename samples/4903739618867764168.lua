...
counter_2 = 0
counter_3 = 0
for jlogjjjjjjjjjlDjjjj0, _, Name0 in ''  do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = '' ; 
end
; 
for jlogjjjjjjjjjlDjjjj0, _, Name0 in -0.000000  do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0, Name0, Name0, Name8 in ''  do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name0, Name0, Name0, Name0 in ''  do
