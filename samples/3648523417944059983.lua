...
for __pairs = always_number( (setmetatable({ [ not_nan_and_nil(( ... ).__pairs) ] = ''; Name0 = '', [ not_nan_and_nil('') ] = nil .. 2.000000, [ not_nan_and_nil('') ] = nil .. 2.000000, }, table_mt))()), always_number(''), always_number('') do
