...
---------------------- END OF PREAMBLE ----------------------------
if  (setmetatable({ [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(nil) ] = '' }, table_mt))() then
	if  (setmetatable({ [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil( ... ) ] = '', Name0 = '', [ not_nan_and_nil(nil) ] = '' }, table_mt))() then
	end
; 
end
; 
