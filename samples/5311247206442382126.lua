...
---------------------- END OF PREAMBLE ----------------------------
Name0 = '' ; 
local Name8 = true,  (setmetatable({ [ not_nan_and_nil(-1000.000000 == -3.000000 and -3.000000) ] = '', [ not_nan_and_nil( (setmetatable({ Name0 = ''; }, table_mt))()) ] = true, _ = -1000.000000 }, table_mt))() ; 
