...
---------------------- END OF PREAMBLE ----------------------------
Name0 =  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))() ; 
Name0 =  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))() ; 
