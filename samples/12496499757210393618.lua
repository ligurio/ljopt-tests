...
counter_0 = 0
local Name5, Name5; 
local ____, ____ = not  function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;

end
 ; 
Name0:Name0  (setmetatable({  }, table_mt))()[(Name0 and  (setmetatable({  }, table_mt))())[''] and  (setmetatable({  }, table_mt))()], Name0:Name0  (setmetatable({  }, table_mt))()[only_numbers_cmp(Name0, '<=', nil)] , Name0.Name  = nil,  ...  ; 
