...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(2.000000), always_number('') do
...
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(Name0), always_number(Name0) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))()), always_number(Name0) do
