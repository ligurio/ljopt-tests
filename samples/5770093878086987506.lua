...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ -0.003837, Name0 = '', Name0 = ''; Name0 = true, }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;

end
; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() == '') ] = '', [ not_nan_and_nil(-0.003837) ] = '', Name0 = '', [ not_nan_and_nil(-0.003837) ] = '', Name0 = ''; }, table_mt))() do
