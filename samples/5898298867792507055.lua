...
counter_4 = 0
counter_5 = 0
for Name0 = always_number(''), always_number(-8.500000), always_number(-8.500000) do
...
; 
for Name4 = always_number(-0.000000), always_number(Name0), always_number(-8.500000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number(''), always_number(-8.500244) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for Name4 = always_number(''), always_number('') do
...
; 
for Name4 = always_number(''), always_number(Name0), always_number(-0.132812) do
