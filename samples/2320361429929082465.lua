...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name1 = always_number(''), always_number(Name0), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = 1000.000000, -0.000000, 0.000000, -2.750000, 1.000000, -0.000031, 2.000456, -0.011719, -2.500000, -2.000000, 8.500000, '', '', nil, false, Name0 ; 
