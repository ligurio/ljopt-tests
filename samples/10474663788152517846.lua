...
; 
for Name4 = always_number(''), always_number(''), always_number(-0.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number(''), always_number(Name0), always_number(Name0) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for Name0 = always_number(''), always_number(Name0), always_number(-2.000000) do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
end
; 
for Name0 = always_number(-8.000000), always_number(Name0) do
...
; 
Name0 = -8.000000,  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() ; 
end
; 
