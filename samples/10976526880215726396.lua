...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(0.000000), always_number(45.000008) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
if  (setmetatable({ '', Name0 = '', [ not_nan_and_nil('') ] = '' }, table_mt))() then
	end
; 
for ____________________ = always_number(''), always_number(45.000008) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
if  (setmetatable({ '', Name0 = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() then
	end
; 
end
; 
