...
for Name0 = always_number(Name0), always_number(0.500000) do
...
; 
for U = always_number(Name0), always_number(2.000000), always_number('') do
...
; 
for Name0 = always_number(-0.000000), always_number(0.500000) do
