...
counter_0 = 0
counter_1 = 0
for Name4 = always_number(''), always_number((-0.000050)), always_number( (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name4 in -0.000050 * -0.000050 * only_numbers_cmp('', '>', '')  do
