...
counter_3 = 0
Name0 = '' ; 
for Name0 = always_number(not  ''), always_number(not  ''), always_number(- '' and '') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(-468.750000), always_number(0.000000), always_number(-468.750000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = '' ; 
end
; 
for utf8_charpattern = always_number(''), always_number(1.500000) do
...
Name0 = '' ; 
Name0 = '' ; 
for Name0 = always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number(false), always_number(-468.750000) do
