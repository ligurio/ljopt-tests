...
counter_2 = 0
counter_3 = 0
while  (setmetatable({ [ not_nan_and_nil(1.000000) ] = function ( ... )
...
; 
while  (setmetatable({ Name0 =  (setmetatable({ [ not_nan_and_nil('') ] = Name0 }, table_mt))(), #  (setmetatable({  }, table_mt))(), }, table_mt))() do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
while  (setmetatable({ ____ = '', Name0 = '', }, table_mt))() do
