...
counter_1 = 0
counter_2 = 0
for UUUUUUUUUUUUUUUUUUUU = always_number('UUUUUUUUUUUUUUUUUUUU'), always_number('UUUUUUUUUUUUUUUUUUUU'), always_number('UUUUUUUUUUUUUUUUUUU') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for UUUUUUUUUUUUUUUUUUUU = always_number(''), always_number('UUUUUUUUUUUUUUUUUUUU') do
