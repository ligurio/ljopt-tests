...
counter_0 = 0
counter_1 = 0
for Name8 = always_number(not  ''), always_number(''), always_number(nil) do
...
; 
Name0, Name0  = '',  (setmetatable({  }, table_mt))(), '', 400.500000,  (setmetatable({  }, table_mt))(), 400.500000,  (setmetatable({  }, table_mt))(), '', '',  (setmetatable({  }, table_mt))(), '',  (setmetatable({ Name0 = '', }, table_mt))(),  (setmetatable({  }, table_mt))(), 0.000000 ; 
