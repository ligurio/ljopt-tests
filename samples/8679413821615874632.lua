...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(3.000000), always_number(3.000000 - '' - -1000.000000 ^ 3.000000 - 3.000000), always_number( (setmetatable({ [ not_nan_and_nil( ... ) ] = '' }, table_mt))() - 3.000000 - 3.000000 - '') do
