...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(only_numbers_cmp(-0.000031 and -2.000001, '<=', '')), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(only_numbers_cmp(-0.000031 ^ -2.000001, '<=', '')), always_number('') do
