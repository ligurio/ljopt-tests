...
---------------------- END OF PREAMBLE ----------------------------
local Name0 = -0.000031, nil, '',  (setmetatable({ true, [ not_nan_and_nil(false) ] = '' }, table_mt))(), 'recunroll=', -0.000031, 10.500000, '\\', only_numbers_cmp(2.058318, '<', -0.000031), '', 0.000000, 8.500000,  ... , '', Name0, '', false ; 
Name0 = '' ; 
