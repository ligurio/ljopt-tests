...
until #  (setmetatable({ '', [ not_nan_and_nil('') ] = Name0:Name0  (setmetatable({  }, table_mt))(), nil, nil, nil, nil, '', [ not_nan_and_nil('') ] = Name0:Name0  (setmetatable({  }, table_mt))(), nil, nil, nil }, table_mt))() == -327.027144; 
