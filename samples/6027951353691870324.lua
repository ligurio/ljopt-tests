...
if nil and '' then
	Name0 = '' ; 
for Name0 = always_number(''), always_number(1.500000) do
...
; 
for Name8 = always_number(# ''), always_number(not  '') do
...
Name0 = '' ; 
Name0 = '' ; 
for Name0 = always_number(Name0), always_number(false), always_number(1.500000) do
