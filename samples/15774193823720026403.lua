...
; 
until false; 
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(true) ] = '', Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() do
