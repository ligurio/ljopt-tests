...
counter_4 = 0
counter_5 = 0
for Name1 = always_number(-0.000000), always_number(0.000000), always_number(nil) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name1 = always_number(2.035156), always_number(0.000000), always_number(function (  )
...
Name0, else_1  =  (setmetatable({ false }, table_mt))(), Name0 ; 
end
; 
Name0[''] =  (setmetatable({  }, table_mt))(), 0.000000 ; 
end
; 
