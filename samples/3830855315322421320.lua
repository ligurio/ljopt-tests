...
Name0:Name0  (setmetatable({  }, table_mt))(); 
while  (setmetatable({ [ not_nan_and_nil(true) ] =  ... , Name0 = '', 416.000000 / -0.000050, [ not_nan_and_nil(true) ] = -0.000000, [ not_nan_and_nil(false) ] = -0.000000, [ not_nan_and_nil(false) ] = nil }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(true) ] =  ... , Name0 = '', [ not_nan_and_nil(-0.000050) ] =  ... , [ not_nan_and_nil(true) ] = -0.000000, [ not_nan_and_nil(false) ] = -0.000000 }, table_mt))() do
