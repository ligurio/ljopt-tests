...
counter_1 = 0
local Name0; 
for Name2 = always_number(44.000031), always_number(0.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = 0.000000 }, table_mt))(), '' ; 
end
; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name2 = always_number(44.000011), always_number(44.000000), always_number(-0.000000) do
