...
for __pairs = always_number( (setmetatable({ [ not_nan_and_nil('') ] = ''; Name5 = '', Name0 = '', [ not_nan_and_nil('') ] =  (setmetatable({ Name0 = '', Name0 = ''; }, table_mt))() .. 2.000000, }, table_mt))()), always_number(''), always_number(416.000000) do
