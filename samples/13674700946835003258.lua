...
counter_0 = 0
counter_1 = 0
local Name0 = true, -0.000000, '' ; 
local Name1 = not  function ( ... )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
 ; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', nil, Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', nan, -0.000000, Name0 = '', -0.000000, nan, -0.000000, -0.004500, Name0 = '', Name0 = '' }, table_mt))() do
