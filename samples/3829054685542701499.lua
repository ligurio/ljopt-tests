...
counter_1 = 0
Name0 = '' ; 
Name0, Name0  = '', true, nil, '', '', '', '', false, '', 163.462693, 124.005822, '' ; 
Name0 = '' ; 
Name0 = '' ; 
Name0 = '' ; 
Name0 = '' ; 
Name0 =  ... , '', -0.005722, 163.437503, -0.005722, '', '', false, function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
, 163.462693, -0.005721, '' ; 
local Name0; 
Name0 = '', 163.449388, '', '', '', true, '', '', function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
return '', '', -0.005722, 163.437503, -0.005722, '', '', false, 163.437503, -0.005721, ''  ; 
end
, '', '' ; 
