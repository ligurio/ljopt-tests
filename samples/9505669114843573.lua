...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(#  (setmetatable({ Name0 = ''; }, table_mt))() % false), always_number(Name0  (setmetatable({ Name0 = ''; }, table_mt))()  (setmetatable({  }, table_mt))()), always_number(-0.000000) do
