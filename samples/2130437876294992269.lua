...
Name0 (); 
Name0  (setmetatable({ [ not_nan_and_nil(#  (setmetatable({  }, table_mt))()) ] = ( (setmetatable({ [ not_nan_and_nil(#  (setmetatable({  }, table_mt))()) ] = Name0, [ not_nan_and_nil(false) ] = '' }, table_mt))()) }, table_mt))(); 
Name0 (); 
