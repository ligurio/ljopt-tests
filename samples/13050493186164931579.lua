...
if '' then
	if '' == '' == only_numbers_cmp(- ('\file:flush0D'), '>', '') then
	end
; 
for U = always_number(''), always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number(1000.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
if 0.000000 == false then
	end
; 
end
; 
