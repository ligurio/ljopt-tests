...
; 
if only_numbers_cmp('', '<', only_numbers_cmp(only_numbers_cmp(only_numbers_cmp('', '>', function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
Name0 = '' ; 
end
), '>', only_numbers_cmp('', '>', only_numbers_cmp('', '<',  (setmetatable({  }, table_mt))()))), '>', only_numbers_cmp('', '>', ''))) then
	end
; 
