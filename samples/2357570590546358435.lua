...
counter_2 = 0
counter_3 = 0
for ________________ = always_number(''), always_number('') do
...
for Name0 = always_number(''), always_number(Name0:I  (setmetatable({  }, table_mt))()), always_number( (setmetatable({ [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(nil) ] = '' }, table_mt))()) do
...
; 
for Name0 = always_number(-2.500000), always_number(not  '') do
