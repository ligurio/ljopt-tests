...
; 
while  (setmetatable({ [ not_nan_and_nil(10.000000) ] = nan, Name0 = '', [ not_nan_and_nil(true) ] = 10.000000, [ not_nan_and_nil(true) ] = nan }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name0  (setmetatable({ -416.000000 }, table_mt))().Name , Name0.coroutine_close  = Name0.coroutine_close, '\'', Name0 ; 
function Name0(  )
