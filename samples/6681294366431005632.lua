...
counter_0 = 0
counter_1 = 0
if only_numbers_cmp(only_numbers_cmp(-0.000000, '<=', -0.000000), '<=', only_numbers_cmp(-0.000000, '<=', -0.000000)) then
	
end
; 
if only_numbers_cmp(false, '<=', -0.000000) == function (  )
...
; 
if only_numbers_cmp(-0.000000, '<=', -0.000000) or only_numbers_cmp(only_numbers_cmp(-0.000000, '<=',  ... ), '<=', not  NNNNNNNNNNNNNNNNNNNN) then
	elseif function (  )
