...
; 
for Name0 = always_number(''), always_number(false), always_number(false) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number( (setmetatable({  }, table_mt))()), always_number(Name0), always_number(nil) do
...
; 
for Name0 = always_number((0.000000 .. 0.000000 .. -2.775879 % '' or 0.000000 .. '')), always_number(Name0), always_number('') do
