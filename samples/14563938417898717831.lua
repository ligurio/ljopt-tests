...
counter_0 = 0
Name0 = '' ; 
for Name4 = always_number( (setmetatable({ 1000.000000, -0.000050 * -0.000050 * only_numbers_cmp(-0.000050, '>=', not  true),  (setmetatable({ Name0 = '' }, table_mt))(), }, table_mt))()), always_number('') do
