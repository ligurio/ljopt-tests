...
---------------------- END OF PREAMBLE ----------------------------
Name0, ( (setmetatable({ nil }, table_mt))()).Name  = Name0:Name0  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
Name0, Name0:Name0  (setmetatable({  }, table_mt))()['\'']  = -0.000000, '', Name0:Name0  (setmetatable({  }, table_mt))() ; 
