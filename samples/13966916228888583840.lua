...
counter_4 = 0
counter_5 = 0
for Name0 = always_number(''), always_number('UUUUUUUUUUUUUUUUUUUU'), always_number('') do
...
; 
for Name0 = always_number(''), always_number(''), always_number('UUUUUUUUUUUUUUUUUUUU') do
