...
counter_0 = 0
counter_1 = 0
local Name0 = not  '', '', 20.500000, true ; 
Name0 = not  '' ; 
Name0, Name0  = 20.500000, '', 20.500000 ; 
for Name0 = always_number('' == ''), always_number(''), always_number(function (  )
...
; 
local Name0, _ = false, Name0 (not  true )  (setmetatable({  }, table_mt))()[''] ; 
