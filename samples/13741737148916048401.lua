...
---------------------- END OF PREAMBLE ----------------------------
local Name0 = 8.500000, '', '',  (setmetatable({ true, Name0 = '' }, table_mt))(),  (setmetatable({ false }, table_mt))(), -0.000031, 10.500000, '\\', 2.066895 ^ -1000.000000, 0.000000, -2.000000, 8.500000,  ... , -1000.000000, 2.000000, 4.000000, Name0:Name0  (setmetatable({  }, table_mt))() ; 
Name0 = '' ; 
