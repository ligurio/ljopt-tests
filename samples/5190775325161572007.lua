...
until nil; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', -0.000000, [ not_nan_and_nil('') ] = false, [ not_nan_and_nil('') ] = false, [ not_nan_and_nil(9.000000) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))() }, table_mt))() do
