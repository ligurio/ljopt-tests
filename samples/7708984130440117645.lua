...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(''), always_number(# only_numbers_cmp('', '<', true) %  ... ) do
...
for ____ = always_number( (setmetatable({ Name0 = '' }, table_mt))()), always_number(-0.000050), always_number(Name0) do
