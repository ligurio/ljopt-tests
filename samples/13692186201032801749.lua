...
counter_0 = 0
counter_1 = 0
for Name7 = always_number(''), always_number(''), always_number( (setmetatable({ Name0 =  (setmetatable({  }, table_mt))(), Name0 =  (setmetatable({  }, table_mt))(), Name0 =  (setmetatable({  }, table_mt))() }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(''), always_number(''), always_number( (setmetatable({ Name0 = '',  (setmetatable({  }, table_mt))() }, table_mt))()) do
