...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(-31.000000), always_number(''), always_number(false) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil('') ] = '', Name0 = '', 32.437499, Name0 = '', [ not_nan_and_nil(-60.000008) ] = true }, table_mt))() do
