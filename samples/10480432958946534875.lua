...
counter_1 = 0
counter_2 = 0
Name0 = 1000.000000 ^ -48.000000, -2.750000 ; 
for Name6 = always_number(''), always_number(Name0:Name0 ('' )), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(-0.000000), always_number(Name0), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(-0.000000), always_number(Name0), always_number(false) do
...
; 
Name0  (setmetatable({ Name0 = (nil)[''] }, table_mt))(); 
Name0 = '' ; 
