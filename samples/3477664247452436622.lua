...
; 
for Name0 = always_number(''), always_number(''), always_number(-1.500000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name4 = always_number( (setmetatable({ Name0 = '', Name0 = '', -1.500000, -1.500000, Name0 = '', '', Name0 = '', Name0 = '', }, table_mt))()), always_number(''), always_number(-1.500000) do
