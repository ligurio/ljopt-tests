...
counter_4 = 0
counter_5 = 0
(45.000000)  (setmetatable({  }, table_mt))(); 
...
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0:Name0  (setmetatable({  }, table_mt))(); 
( (setmetatable({  (setmetatable({ Name0 = '', }, table_mt))() }, table_mt))()):Name0  (setmetatable({  }, table_mt))(); 
for Name7 = always_number(0.000000), always_number(45.000000) do
...
Name0 = '' ; 
Name0 = '' ; 
for Name7 = always_number(''), always_number(45.000000) do
