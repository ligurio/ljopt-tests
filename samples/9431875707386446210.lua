...
; 
if only_numbers_cmp(only_numbers_cmp('', '>', ''), '>', '' ==  (setmetatable({ Name0 =  (setmetatable({ Name0 = '', }, table_mt))() }, table_mt))()) then
	end
; 
for _ = always_number( (setmetatable({ Name0 = '', }, table_mt))()), always_number(''), always_number(-0.000000) do
