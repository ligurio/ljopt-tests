...
; 
for Name8 = always_number(not  ''), always_number(only_numbers_cmp(0.000000, '<=', only_numbers_cmp(0.000000, '<=', -1000.000000 * '' * function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
end
 / -1000.000000))), always_number('') do
...
; 
for ________ = always_number(# true), always_number(-3.000000), always_number('') do
