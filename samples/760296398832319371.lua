...
counter_1 = 0
counter_2 = 0
Name0, Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0._ , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0.LiteRunt , Name0 , Name0 , Name0 , Name0.LiteRunt , Name0 , Name0 , Name0 ( (setmetatable({ Name0 = '', }, table_mt))(), '' ).Name , Name0 , Name0.LiteRunt , Name0  = '' ; 
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(function ( ... )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
) ] = '' }, table_mt))() .. ''), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
local function ____________________ (  )
