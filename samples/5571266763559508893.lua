...
counter_3 = 0
counter_4 = 0
for Name3 = always_number('' == ''), always_number(1.000000), always_number(nil) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
for ________ = always_number(17.000000), always_number(-15.500000), always_number(-2.250116) do
...
; 
for Name0 = always_number(-9.498047), always_number( (setmetatable({ [ not_nan_and_nil('') ] = 0.000000 }, table_mt))()) do
