...
; 
Name0 = '' ; 
while  (setmetatable({ [ not_nan_and_nil('') ] = '', Name0 = '', [ not_nan_and_nil(true) ] = '' }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] = '', Name0 = '', [ not_nan_and_nil('') ] = false }, table_mt))() do
