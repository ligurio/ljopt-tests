...
Name0 = '' ; 
Name0 = '' ; 
for Name8 = always_number(not  ''), always_number(0.000000 .. -1000.000000 * -1000.000000 + '' .. 416.000000 * -1000.000000 / -1000.000000), always_number(-1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name2 = always_number(# ''), always_number(-3.000000), always_number(-1000.000000) do
