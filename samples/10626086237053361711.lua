...
while  (setmetatable({ [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil(Name0) ] = '', Name0:Name0  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] = -0.000000, [ not_nan_and_nil('') ] = '' }, table_mt))() do
