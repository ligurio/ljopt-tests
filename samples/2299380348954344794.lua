...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name4 in 118.784988,  (setmetatable({ Name0 = ''; }, table_mt))(), nil, Name0, '', 0.000000, not  '', '', Name0  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))(), 0.000000  do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
('' - ''):____________________  (setmetatable({  }, table_mt))(); 
Name0:____________________  (setmetatable({  }, table_mt))(); 
