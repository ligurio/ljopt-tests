...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0 = #  (setmetatable({ Name0 = '', '' }, table_mt))() +  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))() ; 
while  (setmetatable({ [ not_nan_and_nil(nil) ] = '',  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))(), [ not_nan_and_nil(Name0) ] = ''; '',  (setmetatable({ Name0 = '', '' }, table_mt))() }, table_mt))() do
