...
---------------------- END OF PREAMBLE ----------------------------
(true).Name, Name0 , utf8_len , ( (setmetatable({  }, table_mt))())[#  (setmetatable({  }, table_mt))()] , ( (setmetatable({  }, table_mt))())[#  (setmetatable({  }, table_mt))()] , Name0 , Name0:Name0  (setmetatable({  }, table_mt))()[''] , ( (setmetatable({  }, table_mt))())[# ''] , ( (setmetatable({  }, table_mt))())[#  (setmetatable({  }, table_mt))()]  = not   (setmetatable({  }, table_mt))() ; 
