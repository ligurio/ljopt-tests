...
for Name0 = always_number(Name0), always_number(-128.031250), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(3.000000), always_number(Name0) do
...
; 
for Name0 = always_number(-1000.000000), always_number(Name0) do
