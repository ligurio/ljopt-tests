...
; 
Name0 = '' ; 
Name0, Name0  =  (setmetatable({  }, table_mt))(), nil, '', 400.500000,  (setmetatable({  }, table_mt))(), 0.000000,  (setmetatable({  }, table_mt))(),  ... , '', '', '', '', false,  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
