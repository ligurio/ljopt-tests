...
counter_0 = 0
counter_1 = 0
for Name2 = always_number(-18.000000), always_number(519.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil(Name0) ] = false, [ not_nan_and_nil(nil) ] = '' }, table_mt))() do
