...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(-468.750000), always_number(-468.750000), always_number(-468.750000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0._ = '' ; 
for Name0 = always_number(nil), always_number(-468.750000), always_number(-8.148438) do
...
; 
for _ = always_number(-468.750000), always_number(-468.750000), always_number(nil and '' or true) do
...
Name0 = '' ; 
Name0 = '' ; 
for Name0 = always_number(-468.750000), always_number(false), always_number(-468.750000) do
