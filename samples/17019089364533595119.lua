...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' == '', '', '', false, Name0 = '', Name0 = '', string_rep = '', CCCCCCCCCCCCCCCCCCCC = '', ''; [ not_nan_and_nil('' == 'read') ] = false == '', -128.000122, [ not_nan_and_nil(true) ] = ''; '' }, table_mt))() do
