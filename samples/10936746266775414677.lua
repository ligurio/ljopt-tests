...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(#  (setmetatable({ Name0 = ''; }, table_mt))() % 0.000000), always_number(Name0  (setmetatable({ Name0 = ''; }, table_mt))()  (setmetatable({  }, table_mt))()), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
local Name0 =  (setmetatable({  }, table_mt))() ; 
end
; 
Name0 = '' ; 
