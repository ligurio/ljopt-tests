...
counter_1 = 0
Name0 = '' ; 
for Name0 in -0.000031 * -0.000031 * -0.000031 .. '',  (setmetatable({ [ not_nan_and_nil(0.000000) ] = '' }, table_mt))()  do
...
; 
Name0 = false, '' ; 
for z_ in -0.000031 * -0.000031 * -0.000031 .. 'getupvalue',  (setmetatable({ '', [ not_nan_and_nil(0.000000) ] = false }, table_mt))()  do
