...
until ''; 
for ____________________ = always_number(''), always_number(''), always_number(true) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name0 = always_number(-0.000000 .. 358.089695 ^ 118.784988), always_number(''), always_number('') do
