...
counter_1 = 0
counter_2 = 0
for Name4 = always_number(-468.750000), always_number(-464.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(-468.750000), always_number(-0.000000), always_number(-0.000000) do
