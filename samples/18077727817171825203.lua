...
---------------------- END OF PREAMBLE ----------------------------
local Name0 = 8.500000, '', '',  (setmetatable({  }, table_mt))(),  (setmetatable({ true, [ not_nan_and_nil('') ] = '' }, table_mt))(), -0.000031, 10.500000, '\\', only_numbers_cmp(false, '<=',  (setmetatable({ Name0 = ''; }, table_mt))()), -2.500031, -2.000000, Name0 ''  (setmetatable({  }, table_mt))()  (setmetatable({  }, table_mt))(),  ... , -1000.000000, 2.000000, 4.000000, Name0:Name0  (setmetatable({  }, table_mt))() ; 
Name0 = '' ; 
