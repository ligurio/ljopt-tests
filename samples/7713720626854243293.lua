...
---------------------- END OF PREAMBLE ----------------------------
local Name0 =  (setmetatable({ Name0 = '', [ not_nan_and_nil('' - -1000.000000 * 1000.000000 - '') ] = -1000.000000, not   (setmetatable({ Name0 = '' }, table_mt))(), Name0 = '', Name0 = '', -1000.000000 + -1000.000000, }, table_mt))() ; 
