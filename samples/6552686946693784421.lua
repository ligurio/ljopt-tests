...
Name0 = -1.062498, 3.125000, 1.999995, 44.003186, '', '', 34.000000, true, 4.000000, 3.000000, '', Name0:Name0  (setmetatable({  }, table_mt))(),  ...  ; 
end
; 
for Name0 in ''  do
...
; 
for ___E2 = always_number(44.500000), always_number(''), always_number(-0.000000) do
