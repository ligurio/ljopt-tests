...
---------------------- END OF PREAMBLE ----------------------------
local Name7 =  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))() ; 
