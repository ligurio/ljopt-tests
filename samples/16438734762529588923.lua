...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil(#  (setmetatable({  }, table_mt))()) ] = 0.000000,  (setmetatable({ [ not_nan_and_nil(false) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(false) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(false) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(false) ] =  (setmetatable({  }, table_mt))() }, table_mt))(), }, table_mt))() do
