...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0:io_output  (setmetatable({  }, table_mt))(); 
Name0, Name0[# '']  = 1000.000000, 0.000000, function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
return; 
end
, true, '', '', '', 31.000000,  ... , -128.252060, 8.500000, '', -1000.000000, 8.499993, 4.000000, Name0:Name0  (setmetatable({  }, table_mt))() ; 
