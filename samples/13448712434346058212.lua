...
for Name0 = always_number(0.000000), always_number( (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))()), always_number(Name0) do
...
; 
for Name0 = always_number(0.000000), always_number( (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))()), always_number(not  '') do
