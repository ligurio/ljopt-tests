...
; 
Name0 = '' ; 
for Name0 = always_number(not  -48.000000 .. 1000.000000 ^ -48.000980), always_number(1000.000000), always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = ('')[''] }, table_mt))()) ] = '' }, table_mt))() == '') do
