...
---------------------- END OF PREAMBLE ----------------------------
Name0 =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))(); Name0 = ''; [ not_nan_and_nil(0.000000) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))(), Name2 }, table_mt))(), '' ; 
