...
---------------------- END OF PREAMBLE ----------------------------
Name0:Name0  (setmetatable({  }, table_mt))()[ ...  and  (setmetatable({  }, table_mt))()], Name0:io_output ''[Name0 or  (setmetatable({  }, table_mt))()] , Name0:Name0  (setmetatable({  }, table_mt))()[not  '']  = 0.000000, '', '', nil, '' ; 
Name0 = '' ; 
