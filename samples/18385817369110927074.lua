...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(17.187500), always_number(-1000.000000 .. - (108.750000 ^ -21.152344 ^ -11.576172)), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({  }, table_mt))(), false, 108.750000 ^ -21.152344 ^ -11.576172 ; 
end
; 
