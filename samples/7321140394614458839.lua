...
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
Name0 ( (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '', true }, table_mt))()) ] = '', [ not_nan_and_nil(only_numbers_cmp('GGGGGGGGGGGGGGGGGGGG', '<=', true) + '' - 0.000000) ] = Name0, true }, table_mt))(), '' ); 
