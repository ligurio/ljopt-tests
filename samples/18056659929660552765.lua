...
; 
local Name4 =  (setmetatable({ Name0 = '', [ not_nan_and_nil(-1000.000000 - 415.937499 .. '') ] = -1000.000000, [ not_nan_and_nil(false) ] = ''; Name0 = '', Name0 = '', }, table_mt))() ; 

until -1000.000000; 
for _ = always_number(''), always_number(','), always_number(-1000.000000) do
