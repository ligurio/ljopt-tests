...
---------------------- END OF PREAMBLE ----------------------------
local Name0 =  (setmetatable({ Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = -1000.000000, [ not_nan_and_nil(only_numbers_cmp(-1000.000000, '<', '' == '') / -1000.000000) ] = true }, table_mt))() ; 
Name0 = '' ; 
