...
counter_0 = 0
Name0 = '' ; 
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil('') ] = nil }, table_mt))() .. nil), always_number(''), always_number( (setmetatable({ Name0 = '', [ not_nan_and_nil(2.000000) ] = -0.000000 }, table_mt))() .. nil) do
