...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(not  ''), always_number(''), always_number(nil) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number('!'), always_number( (setmetatable({  }, table_mt))()) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
Name0, Name0  = '',  (setmetatable({  }, table_mt))(), '', 400.500000,  (setmetatable({  }, table_mt))(), 400.500000,  (setmetatable({  }, table_mt))(), true, '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({ Name0 = '', }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
