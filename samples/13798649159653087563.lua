...
; 
for ________________ = always_number(0.000000), always_number(1.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
Name0 '\000\000\000\003'; 
end
; 
Name0 '\000\000\000\003' '\000\000\000\003':Name0  (setmetatable({  }, table_mt))():Name0  (setmetatable({  }, table_mt))(); 
Name0 '\000\000\000\003':Name0  (setmetatable({  }, table_mt))():Name0  (setmetatable({  }, table_mt))(); 
