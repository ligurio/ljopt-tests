...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(4.000130), always_number( (setmetatable({ Name0 = ''; }, table_mt))()), always_number(4.000130) do
...
; 
for Name0 = always_number(0.000000), always_number(4.000130), always_number(4.000130) do
