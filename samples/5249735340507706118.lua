...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(only_numbers_cmp(only_numbers_cmp('', '>=', ''), '>=', '')), always_number(''), always_number(only_numbers_cmp(only_numbers_cmp('', '>=', ''), '>=', only_numbers_cmp('', '>=', ''))) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = '' ; 
Name0 = only_numbers_cmp('', '>=', ''), only_numbers_cmp(only_numbers_cmp('', '>=', ''), '>=', ''), '' ; 
end
; 
