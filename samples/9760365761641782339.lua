...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(true) ] = '', nan; -1000.000000,  ... ; ''; [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', nan, nan, nil, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() do
