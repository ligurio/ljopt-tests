...
if  (setmetatable({ Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() then
	end
; 
Name7, Name1  = '' ; 
for Name7 = always_number(''), always_number(Name0) do
