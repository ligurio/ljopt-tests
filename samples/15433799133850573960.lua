...
---------------------- END OF PREAMBLE ----------------------------
( (setmetatable({ '', }, table_mt))()).Name, Name0:Name0  (setmetatable({  }, table_mt))().Name , ( (setmetatable({ '' }, table_mt))()).Name  = '' ; 
(nil).Name, ( (setmetatable({ '', '', -0.000000 }, table_mt))())._ , ('').Name  = '' ; 
Name0:Name0  (setmetatable({  }, table_mt))().Name, Name0:Name0  (setmetatable({  }, table_mt))()[Name0 or  (setmetatable({  }, table_mt))()] , Name0  = '' ; 
