...
for Name8 = always_number( (setmetatable({ Name0 = '', }, table_mt))()), always_number(false), always_number(-0.000000) do
...
break; 
until ''; 
for Name0 = always_number(2.000000), always_number( (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))()), always_number('') do
