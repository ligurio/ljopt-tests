...
if  (setmetatable({  }, table_mt))() then
	Name0 = '' ; 
end
; 
Name4 =  (setmetatable({  }, table_mt))(), '' == 0.000000 ; 
end
; 
Name0, Name0 , Name0 , Name0  = '',  (setmetatable({  }, table_mt))(),  (setmetatable({ '', [ not_nan_and_nil(Name0) ] = '', ''; }, table_mt))() ; 
end
; 
