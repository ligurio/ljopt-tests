...
; 
for Name0 in false  do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
local Name0, Name0; 
for Name9 = always_number(''), always_number(0.000000), always_number(nil) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for _ = always_number(Name0), always_number(0.000000), always_number(-960.000000) do
