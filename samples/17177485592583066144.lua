...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0, Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0 , Name0  = 2.812500 ; 
while  (setmetatable({ [ not_nan_and_nil(Name0[Name0 ((not  false) == '' )]) ] = '', [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))() do
