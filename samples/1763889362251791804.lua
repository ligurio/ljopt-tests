...
counter_4 = 0
counter_5 = 0
for Name6 = always_number(''), always_number( (setmetatable({  }, table_mt))()), always_number((nil)) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name6 = always_number(nil ==  ... ), always_number(''), always_number(Name0) do
...
for Name0 = always_number(''), always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))() }, table_mt))()), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name0 = always_number(''), always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number( ... ) do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
end
; 
for Name0 = always_number(nil), always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number(Name0) do
