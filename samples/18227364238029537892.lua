...
until #  (setmetatable({ [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil( (setmetatable({ - 23.250000; [ not_nan_and_nil('') ] = Name0 }, table_mt))()) ] = Name0, [ not_nan_and_nil('') ] = Name0, Name0 = '' }, table_mt))()) ] = '', - -21.152344 }, table_mt))(); 
