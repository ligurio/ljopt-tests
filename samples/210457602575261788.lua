...
counter_2 = 0
counter_3 = 0
for Name4 = always_number(''), always_number(#  (setmetatable({ Name0 = '' }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(''), always_number(#  (setmetatable({ Name0 = '' }, table_mt))()) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name3 = always_number(''), always_number(#  (setmetatable({ Name0 = '' }, table_mt))()) do
