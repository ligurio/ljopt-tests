...
---------------------- END OF PREAMBLE ----------------------------
local io_flush = -0.000031, '', '',  (setmetatable({ 4.000000, true }, table_mt))(),  (setmetatable({ '\\', [ not_nan_and_nil('') ] = '' }, table_mt))(), -0.000031, 10.500000, '\\', '' ^ '', false,  ... , 8.499756,  ... , 0.000000, 2.000000, 4.000000, -1000.000000 ; 
