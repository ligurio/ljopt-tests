...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(0.000000), always_number(288.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(''), always_number(#  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name5 = '', [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = '' }, table_mt))()) do
