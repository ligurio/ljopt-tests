...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(''), always_number(-31.000000), always_number(-2.500376) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name4 = always_number(function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
end
), always_number(0.000000), always_number(Name0) do
