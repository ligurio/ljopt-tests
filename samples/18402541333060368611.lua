...
local Name0, S; 
Name0 = '' ; 
z, ( (setmetatable({ Name0 = ''; }, table_mt))())[-1000.000000 ^ 84.000000 ^ ( (setmetatable({ Name0 = '' }, table_mt))())]  = '', nil, -0.011719, ( (setmetatable({ -1000.000000 ^ 84.000000; }, table_mt))()),  (setmetatable({ Name0 = ''; }, table_mt))() ; 
