...
---------------------- END OF PREAMBLE ----------------------------
((false and only_numbers_cmp((false), '>=', false))):abc  (setmetatable({  }, table_mt))()  (setmetatable({  }, table_mt))() 'ab'; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
((false and only_numbers_cmp((false), '>=', ''))):abc  (setmetatable({  }, table_mt))()  (setmetatable({  }, table_mt))() 'ab'; 
