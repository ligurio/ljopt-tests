...
counter_2 = 0
Name0 = -2.750000 ; 
for Name0 = always_number(''), always_number(Name0), always_number(-0.000000) do
...
; 
for Name0 = always_number(( (setmetatable({ Name0 = '', }, table_mt))())), always_number('' .. ''), always_number(-2.750000) do
