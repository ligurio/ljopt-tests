...
Name0 =  (setmetatable({  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))() ; 
function ____________________.Name0(  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
Name0 = '' ; 
end
; 
function Name6( Name0 )
...
; 
Name0:Name0  (setmetatable({ Name0 = '', }, table_mt))(); 
