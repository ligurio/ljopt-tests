...
; 
while  (setmetatable({ [ not_nan_and_nil(10.000000) ] = 10.000000, Name0 = '', [ not_nan_and_nil(true) ] = nan, [ not_nan_and_nil(true) ] = nan }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = '' ; 
while  (setmetatable({ [ not_nan_and_nil(false) ] = nan, Name0 = '', [ not_nan_and_nil(true) ] = nan, [ not_nan_and_nil(false) ] =  ...  }, table_mt))() do
