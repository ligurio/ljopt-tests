...
; 
for Name8 = always_number(-468.750000), always_number(not  '') do
...
Name0 = '' ; 
Name0 = '' ; 
for Name0 = always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number(false), always_number(1.500000) do
