...
counter_2 = 0
counter_3 = 0
Name0, Name0[ (setmetatable({ Name0 = '' }, table_mt))()] , Name0:Name0  (setmetatable({  }, table_mt))()[function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
]  =  (setmetatable({  }, table_mt))(), '' ; 
Name0, Name0[ (setmetatable({  }, table_mt))()] , Name0[ (setmetatable({  }, table_mt))()] , Name0 , Name0 , Name0[function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
end
] , Name6  = '', -1000.000000, '' ; 
Name0, Name0[Name0:Name0  (setmetatable({  }, table_mt))()] , Name0 , Name0 , Name0[function ( Name0 )
