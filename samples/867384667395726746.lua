...
counter_0 = 0
counter_1 = 0
for _ = always_number( (setmetatable({ Name0 = '' }, table_mt))()), always_number(''), always_number(-0.242187) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = -1.062498, 3.125000, 1.999995, 0.000000, -0.000000, '', 34.000000, '', 4.000000, 3.000000, 0.000000, Name0:Name0  (setmetatable({  }, table_mt))(),  ...  ; 
end
; 
for Name0 in  ...   do
