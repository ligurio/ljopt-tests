...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ [ not_nan_and_nil('') ] = true, [ not_nan_and_nil('') ] = nil, [ not_nan_and_nil('') ] = nil, 'string.byte' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil('') ] = true, [ not_nan_and_nil('') ] = nil, [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = true }, table_mt))() do
