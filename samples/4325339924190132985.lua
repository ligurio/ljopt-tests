...
Name0, Name0[-960.000000] , Name0 , Name0 , Name0 , Name0 , Name0  =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0, '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0,  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))(), true ; 
until  ... ; 
