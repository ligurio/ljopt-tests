...
; 
Name0 = '' ; 
Name0 =  (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = '' }, table_mt))() ; 
for z_ in  (setmetatable({ [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil(-1000.000000) ] =  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = '' }, table_mt))(), }, table_mt))()) ] = -1000.000000, Name0 = '', }, table_mt))()  do
