...
Name0 = -1.062498, 3.125000, 1.999995, 0.000000, -0.000000, '', 34.000000, 4.000004, 4.000000, 3.000000, 0.000000, Name0:Name0  (setmetatable({  }, table_mt))(),  ...  ; 
end
; 
for Name0 in  ...   do
...
; 
for Name4 = always_number(nil), always_number(''), always_number(-0.000000) do
