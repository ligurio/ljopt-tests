...
counter_0 = 0
counter_1 = 0
for Name0, Name0, Name0, Name0, Name0, Name2 in '__add',  (setmetatable({ [ not_nan_and_nil( (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))()) ] = only_numbers_cmp(# '' .. - '', '>=', '') }, table_mt))(), ''  do
