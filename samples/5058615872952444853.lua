...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({ _ = '', Name0 () }, table_mt))()) ] = '', [ not_nan_and_nil(108.750000 ^ -21.152344 ^ -11.576172) ] = '', [ not_nan_and_nil( (setmetatable({ -11.576172, Name0 }, table_mt))()) ] = '', '' }, table_mt))() do
