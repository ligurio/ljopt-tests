...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(3.000001), always_number(''), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(3.000000), always_number(3.000001 == 3.000000 - 3.000000), always_number(Name0 - 3.000000 - 3.000000 - '' - '') do
