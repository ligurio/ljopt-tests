...
counter_1 = 0
counter_2 = 0
while  (setmetatable({ Name0 = '', Name0 = '', [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = '', Name0:Name0  (setmetatable({  }, table_mt))() }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;

end
; 
while  (setmetatable({ Name0 = '', nil, [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = '', Name0:Name0  (setmetatable({  }, table_mt))() }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
while  (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] =  ... , [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = '', Name0:Name0  (setmetatable({  }, table_mt))() }, table_mt))() do
