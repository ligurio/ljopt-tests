...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(false), always_number( (setmetatable({  }, table_mt))() == ''), always_number(1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
if  (setmetatable({ (-1000.000000 + -1000.000000 - -1000.000000 * -1000.000000 .. 'LUA_INIT') - 0.000000 }, table_mt))() then
	end
; 
end
; 
