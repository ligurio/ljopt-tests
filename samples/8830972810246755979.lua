...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(-2.000000), always_number(2.250000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  ... , [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))() }, table_mt))()), always_number(''), always_number( (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  ... , [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))() }, table_mt))()) do
