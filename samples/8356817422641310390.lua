...
counter_0 = 0
counter_1 = 0
Name0, Name0:Name0  (setmetatable({  }, table_mt))()[function ( Name0 )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
Name0, Name0:Name0  (setmetatable({  }, table_mt))()['\'']  = '', Name0:Name0  (setmetatable({  }, table_mt))() ; 
end
]  = -1000.000000, Name0:Name0  (setmetatable({  }, table_mt))() ; 
Name0.Name, Name0[function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
Name0, Name0:Name0  (setmetatable({  }, table_mt))()['']  = true, Name0:Name0  (setmetatable({  }, table_mt))() ; 
end
]  = Name0:Name0  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
