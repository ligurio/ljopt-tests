...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(5.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(true), always_number(''), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))(), [ not_nan_and_nil('') ] =  ...  }, table_mt))() do
