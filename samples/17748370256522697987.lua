...
for Name0 = always_number(2.000000), always_number(Name0:____________________  (setmetatable({  }, table_mt))()), always_number(1000.000000 * -0.000050 * '') do
...
for Name0 = always_number(-0.000050), always_number('dse'), always_number(nil) do
