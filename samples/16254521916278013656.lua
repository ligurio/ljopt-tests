...
Name0 = '' ; 
Name0 = '' ; 
Name0  (setmetatable({ 2.750000, [ not_nan_and_nil( (setmetatable({  (setmetatable({ Name0 = '', }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(), }, table_mt))()) ] =  (setmetatable({ Name0 = '' }, table_mt))(), [ not_nan_and_nil(5.000000) ] = '' }, table_mt))(); 
