...
for Name0 = always_number(0.000000), always_number(-2.015645), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(0.000000), always_number(-2.000000), always_number(Name0) do
