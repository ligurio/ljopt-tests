...
counter_1 = 0
counter_2 = 0
while  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = '' ; 
Name0 = '' ; 
Name0 = '' ; 
while  (setmetatable({ '', [ not_nan_and_nil('') ] = 0.000000, -0.000050 * -0.000050,  (setmetatable({  }, table_mt))(), }, table_mt))() do
