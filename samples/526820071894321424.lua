...
counter_1 = 0
Name0 = '' ; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', '', -0.000000, false,  ... ,  (setmetatable({ Name0 = '', }, table_mt))(), Name0 = '', function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', -0.000000, ''; '', [ not_nan_and_nil('') ] = Name0 }, table_mt))() do
