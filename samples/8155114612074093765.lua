...
---------------------- END OF PREAMBLE ----------------------------
local Name0 =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({ Name0 = '' }, table_mt))(), [ not_nan_and_nil('' - -1000.000000 * 1000.000000 - -1000.000000) ] = -1000.000000, -1000.000000, Name0 = '', false, }, table_mt))() ; 
