...
while  (setmetatable({ Name0 = ''; ____________________ = '', [ not_nan_and_nil(-0.242187) ] =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() do
...
; 
while  (setmetatable({ Name0 = ''; [ not_nan_and_nil( (setmetatable({ Name0 = '', }, table_mt))()) ] = true, [ not_nan_and_nil(-0.242187) ] =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() do
