...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0 = not   (setmetatable({ Name0 = '', '' }, table_mt))() == (false)[''] ; 
while  (setmetatable({ [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = ''; '',  (setmetatable({ Name0 = ''; '' }, table_mt))() }, table_mt))() do
