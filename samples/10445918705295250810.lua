...
counter_1 = 0
counter_2 = 0
for Name5 = always_number(not  ''), always_number(''), always_number('') do
...
Name0 =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))(), Name1 =  (setmetatable({  }, table_mt))() }, table_mt))(),  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))(), Name1 =  (setmetatable({  }, table_mt))() }, table_mt))(),  ...  ; 
