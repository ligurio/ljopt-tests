...
for Name4 = always_number(''), always_number(0.000000), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name4 = always_number(0.000000), always_number(0.000000), always_number('') do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
for Name4 = always_number(0.000000), always_number(0.000000) do
...
; 
for Name4 = always_number(''), always_number(''), always_number(-0.390625) do
