...
counter_2 = 0
counter_3 = 0
for math_floor, math_floor, Name4, math_floor, Name4, Name8, Name1 in function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
for Name0 = always_number(('\011\000\000\000\000')), always_number(0.125000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
return; 
end
; 
for Name6 = always_number(0.000000), always_number(''), always_number(nil) do
