...
counter_0 = 0
counter_1 = 0
for Name4 = always_number( (setmetatable({ 1000.000000, -0.000050 * -0.000050 .. -0.000050 * '', '' == Name0:Name0 'RRRRRRRRRRRRRRRRRRRR', }, table_mt))()), always_number(nil), always_number(0.000000) do
