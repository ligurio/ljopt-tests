...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(0.000000), always_number( (setmetatable({  }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(Name0), always_number(4.000004), always_number('') do
...
; 
for de__shlbug_getuserva = always_number(0.000000 and  (setmetatable({ Name0 = ''; }, table_mt))() ^ 4.000004), always_number( ... ), always_number(4.000004) do
