...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(1.945312) ] = Name0:Name0  (setmetatable({  }, table_mt))(), Name0 = '', [ not_nan_and_nil(-0.000000) ] = ''; Name0 = '', [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))() do
