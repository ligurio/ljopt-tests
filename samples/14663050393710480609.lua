...
Name0 =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil(-0.226562) ] = nil, [ not_nan_and_nil('') ] = Name0, [ not_nan_and_nil('') ] = '' }, table_mt))(), false, Name0 = '' }, table_mt))() ; 
end
; 
