...
counter_3 = 0
counter_4 = 0
for ____________ = always_number(false), always_number(nil) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for ____________ = always_number(''), always_number(true) do
...
Name0 = '' ; 
until ''; 
return  (setmetatable({ [ not_nan_and_nil(only_numbers_cmp('', '>', '')) ] = '' }, table_mt))()  ; 
end
; 
end
; 
