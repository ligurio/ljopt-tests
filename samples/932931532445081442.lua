...
---------------------- END OF PREAMBLE ----------------------------
Name0 =  (setmetatable({  }, table_mt))(), '', '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(), '', Name0,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
Name0 = (nil), -468.750000, (0.000000 or 0.000000) % Name0, -468.750000 ; 
