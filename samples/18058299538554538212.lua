...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(Name0), always_number(-960.000000), always_number(-1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for ________ = always_number(Name0), always_number(-0.000000), always_number(-960.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(____________________), always_number(-0.000000), always_number(-48.000000 .. 1000.000000 ^ -48.000000) do
