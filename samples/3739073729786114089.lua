...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(-2.000001), always_number(# '') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0, Name0[not  true]  = Name0:______________  (setmetatable({  }, table_mt))(), Name0.debug_setuservalue:______________  (setmetatable({  }, table_mt))(), Name0 ; 
end
; 
