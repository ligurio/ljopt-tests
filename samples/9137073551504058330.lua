...
counter_3 = 0
Name0 = 8.000000 ; 
for Name5 = always_number(''), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(8.000000), always_number(''), always_number(Name0) do
...
for Name0 = always_number(8.000000), always_number(''), always_number('') do
