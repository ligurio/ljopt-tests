...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = nan, [ not_nan_and_nil(nan) ] = '', Name0:Name0  (setmetatable({  }, table_mt))() }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ Name0 = '', Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', Name0:Name0  (setmetatable({  }, table_mt))() }, table_mt))() do
