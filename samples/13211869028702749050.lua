...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(false) ] =  (setmetatable({ Name0 = '' }, table_mt))(); [ not_nan_and_nil(-0.242187) ] =  (setmetatable({ [ not_nan_and_nil(0.000000) ] = '', Name0 = function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
, Name0 = 1000.000000 }, table_mt))() }, table_mt))() do
