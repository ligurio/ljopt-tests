...
counter_1 = 0
Name0 = '' ; 
while  (setmetatable({ [ not_nan_and_nil(false) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(false) ] =  (setmetatable({  }, table_mt))() }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(false) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(false) ] =  (setmetatable({ [ not_nan_and_nil(false) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(false) ] =  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))() do
