...
; 
for Name0 = always_number(-0.000000), always_number(0.125000) do
...
; 
for Name0 = always_number(Name0), always_number(0.000000), always_number('') do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
end
; 
for Name0 = always_number(Name0), always_number('') do
