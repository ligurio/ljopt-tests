...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(-468.750000), always_number(''), always_number(0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number('\allunr'), always_number( (setmetatable({  }, table_mt))()), always_number('') do
...
; 
for Name0 = always_number(-468.750000), always_number(-468.750000), always_number('\allunr') do
