...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0 = 0.000000, -0.000050 * -0.000050 * (0.000000 - 358.089695 ^ 118.784988) * false ; 
for ____________________ = always_number(Name2.Name), always_number(2.773438), always_number(0.000000) do
