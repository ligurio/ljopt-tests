...
; 
for Name4 = always_number(17.187500), always_number(nil), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name0[Name0] , Name0  =  (setmetatable({  (setmetatable({  (setmetatable({  }, table_mt))(), Name0 }, table_mt))(), Name0 }, table_mt))(),  (setmetatable({  }, table_mt))(), '' ; 
end
; 
