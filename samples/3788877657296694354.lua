...
Name0, Name0 , Name0 , Name0 , ( (setmetatable({  }, table_mt))()).Name , ( (setmetatable({  }, table_mt))()).Name , ( (setmetatable({  }, table_mt))()).Name , Name0._ , ( (setmetatable({  }, table_mt))())._ , Name0[''] , Name0 , Name0 , Name0  =  (setmetatable({  }, table_mt))(), true, '', '', '', '', '', '',  (setmetatable({  }, table_mt))(), '' ; 
until  ... ; 
