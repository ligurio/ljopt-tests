...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0 = '',  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() }, table_mt))(), }, table_mt))() ; 
do
Name0 = '' ; 
end
; 
