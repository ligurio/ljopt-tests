...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(''), always_number(-1000.000000 .. -1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil('') ] = '' }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() do
