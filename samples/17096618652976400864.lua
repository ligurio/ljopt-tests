...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
if  (setmetatable({ [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = Name0 }, table_mt))()) ] = (Name0 .. 358.089634 ^ 0.000000 .. -0.000000), Name0 = '', Name0 = '' }, table_mt))() then
	do
end
; 
end
