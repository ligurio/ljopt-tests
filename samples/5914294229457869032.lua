...
---------------------- END OF PREAMBLE ----------------------------
Name0:Name4  (setmetatable({ Name0 = '' }, table_mt))():Name0  (setmetatable({  }, table_mt))(); 
if nil then
	elseif nil then
	end
; 
Name0:Name4  (setmetatable({ [ not_nan_and_nil('') ] = 0.000000 }, table_mt))():Name4  (setmetatable({  }, table_mt))(); 
