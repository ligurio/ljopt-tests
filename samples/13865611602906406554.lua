...
---------------------- END OF PREAMBLE ----------------------------
Name0:Name0  (setmetatable({  }, table_mt))()[ ...  and  (setmetatable({  }, table_mt))()], Name0:Name0  (setmetatable({  }, table_mt))()[( (setmetatable({  }, table_mt))()) or  (setmetatable({  }, table_mt))()] , Name0:Name0  (setmetatable({  }, table_mt))()['' or  (setmetatable({ Name0 = '' }, table_mt))()]  = 0.000000, true, '', nil,  (setmetatable({  }, table_mt))() ; 
Name0 = '' ; 
