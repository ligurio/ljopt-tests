...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(20.500000), always_number(''), always_number(true) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = -1.000000, 1000.000000, 3.000000, -0.000000, 2.000000, 20.500000, 44.000000, 4.000002, 34.000000, 0.000000, false, false,  ...  ; 
end
; 
for Name0 = always_number(''), always_number(''), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = -1.000000, 1000.000000, 3.000000, -0.000000, 2.000000, 20.500000, 44.000000, 4.000000, 34.000000, 168.000000, 0.000000,  ... ,  ...  ; 
end
; 
