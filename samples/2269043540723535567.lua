...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '', Name0 () }, table_mt))()) ] = ''; [ not_nan_and_nil(108.750000 ^ '') ] = '', [ not_nan_and_nil( (setmetatable({ -11.576172, -1000.000000 }, table_mt))()) ] = '', true }, table_mt))() do
