...
counter_4 = 0
counter_5 = 0
for Name0 = always_number(1.562500), always_number(-468.750000), always_number(-468.750000) do
...
; 
for Name0 = always_number(not  ''), always_number(not  ''), always_number('utf8.charpattern') do
