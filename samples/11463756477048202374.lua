...
; 
for Name6 = always_number(# -0.000050 * -0.000050 * -0.000050 * -0.000050 * -0.000050 .. ''), always_number(-1000.000000), always_number(-1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
break; 
end
; 
for Name8 = always_number(# ''), always_number(-1000.000000), always_number(416.000000 / -0.000050) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
break; 
end
; 
for Name2 = always_number(not  ''), always_number(''), always_number(-1000.000000) do
