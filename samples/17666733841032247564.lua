...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name4 = always_number(''), always_number(1.500000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = 1.500000, 0.000000, 3.125000, 1.999756, 44.251007, 44.062500, -0.000000, 34.000000, -1000.000000, '', '', Name0:Name0  (setmetatable({  }, table_mt))(),  ...  ; 
end
; 
