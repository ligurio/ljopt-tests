...
while  (setmetatable({ '', '', [ not_nan_and_nil(5.000000) ] = '', nil }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
while  (setmetatable({ '', [ not_nan_and_nil(4.000000) ] = '', [ not_nan_and_nil(5.000000) ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))() do
