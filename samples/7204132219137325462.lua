...
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name0 = always_number(-3.000000), always_number(''), always_number(nil) do
...
for Name0 = always_number(''), always_number(-3.000000), always_number(Name0) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
Name1 =  (setmetatable({  }, table_mt))() ; 
end
; 
end
; 
