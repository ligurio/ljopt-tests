...
; 
for __ = always_number(''), always_number(''), always_number(false) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name0  = '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '', '', '',  (setmetatable({  }, table_mt))(), ____:Name0  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '\'', ( (setmetatable({  }, table_mt))()) ; 
