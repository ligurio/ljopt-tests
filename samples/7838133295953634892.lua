...
---------------------- END OF PREAMBLE ----------------------------
collectgarbage (nil, 4.000000, Name0 ); 
Name0, Name0  = '' == collectgarbage (nil, 4.000000,  (setmetatable({  }, table_mt))() ) and '',  (setmetatable({  }, table_mt))(), '',  (setmetatable({ Name0 = '', }, table_mt))(), collectgarbage (nil, 4.000000, Name0 ) ; 
