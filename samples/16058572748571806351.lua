...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name4 = always_number(''), always_number(3.125000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0, Name0  =  (setmetatable({ [ not_nan_and_nil(true) ] = -0.000000, -0.000000, [ not_nan_and_nil(8.000000) ] =  (setmetatable({  }, table_mt))() }, table_mt))(), Name0,  (setmetatable({ [ not_nan_and_nil(true) ] = -0.000000, -0.000000, [ not_nan_and_nil(8.000000) ] =  (setmetatable({  }, table_mt))() }, table_mt))(), '' ; 
end
; 
