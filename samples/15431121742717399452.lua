...
while  (setmetatable({ [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(Name0:Name0  (setmetatable({  }, table_mt))()) ] = '', Name0 = '', [ not_nan_and_nil('') ] = '' }, table_mt))() do
