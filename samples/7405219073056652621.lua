...
counter_0 = 0
counter_1 = 0
for Name0, Name0, Name0, Name0, Name0, Name2 in '__add',  (setmetatable({ [ not_nan_and_nil( (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))()) ] = only_numbers_cmp(# '' .. - Name0, '>=', '') }, table_mt))(), ''  do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0, Name0, Name0, Name0, Name8 in '', ''  do
