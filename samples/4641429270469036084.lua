...
counter_4 = 0
counter_5 = 0
for Name7 = always_number('' == ''), always_number(1.000000), always_number(nil) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
for Name0 = always_number(17.000000), always_number(-15.500000), always_number(-2.250116) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name7 = always_number(''), always_number(''), always_number(Name0) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name0 = always_number(-9.498047), always_number(4.000000) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for Name0 = always_number(''), always_number(''), always_number(Name0) do
...
; 
for Name7 = always_number( (setmetatable({ Name0 = '' }, table_mt))()), always_number(''), always_number(true) do
