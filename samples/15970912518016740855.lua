...
,  (setmetatable({  (setmetatable({ -2.003906 .. only_numbers_cmp('', '<=', ''); 0.000000 or not  '' }, table_mt))() }, table_mt))() ; 
for __ = always_number(-1.500000), always_number('_G') do
...
; 
for Name4 = always_number(-1.500000), always_number('') do
