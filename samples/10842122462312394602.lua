...
---------------------- END OF PREAMBLE ----------------------------
local ________ = 0.000000, ( (setmetatable({ Name0 = ''; }, table_mt))()), '' ; 
( (setmetatable({ Name0 = ''; }, table_mt))())[''], Name0 , Name0.rename , Name0 , Name0 , Name0 , ( (setmetatable({ Name0 = ''; }, table_mt))())['']  = 'io.input', '' ; 
