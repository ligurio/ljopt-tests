...
local Name1, Name0; 
Name0 = '' ; 
for Name7 = always_number(2.000000), always_number(2.000000), always_number(0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0, Name1 , Name0  = 2.000000,  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() ; 
end
; 
