...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ '', [ not_nan_and_nil(-19.000000) ] = '', -0.000000, -0.000000, -0.000000, -0.000000, -0.000000, -0.000000 }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ '', [ not_nan_and_nil(-19.000000) ] = '', '', '', '', nil, -0.000000 }, table_mt))() do
