...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ false, '', -19.001654, Name0 = '', 163.449388, -19.001654 }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil('') ] = 'call', '', -19.001654, Name0 = '', 163.449388, -19.001654 }, table_mt))() do
