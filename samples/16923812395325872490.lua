...
---------------------- END OF PREAMBLE ----------------------------
do
Name0.____________________.Name:Name0  (setmetatable({  }, table_mt))()['']  (setmetatable({  }, table_mt))(); 
end
; 
Name0 = -0.983081, 4.000000, 1.500000, 0.000000, -2.750000, 5.500000, -0.011719, -0.011719, 4.500000, '', -412.750000,  ... , 4.000023,  (setmetatable({ true }, table_mt))(), not  4.500000 ; 
