...
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', ________, [ not_nan_and_nil(function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
end
) ] = '', nan, true, [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] = '', -0.000000 }, table_mt))() do
