...
counter_0 = 0
counter_1 = 0
for Name4 = always_number( (setmetatable({ 1000.000000, -0.000050 * -0.000050 .. -0.000050 * '', '' == Name0:Name0 'RRRRRRRRRRRRRRRRRRRR', }, table_mt))()), always_number(-0.000050), always_number(0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 in not  nil  do
