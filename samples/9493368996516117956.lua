...
; 
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(true) ] =  ... , [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(0.000000 or Name0 ('' )) ] = ''; [ not_nan_and_nil('') ] =  ... , [ not_nan_and_nil('coroutine.isyieldabl') ] =  ... , }, table_mt))() do
