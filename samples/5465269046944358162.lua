...
Name0 = '' ; 
Name0 = '' ; 
Name0, Name1 , ( (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))())[true] , ( (setmetatable({ true }, table_mt))())[not   (setmetatable({  }, table_mt))()] , ( (setmetatable({  }, table_mt))()).Name , Name0 , ( (setmetatable({ Name0 = '' }, table_mt))())[''] , Name1  =  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))(), '' ; 
