...
counter_0 = 0
Name0 = '' ; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil('') ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(Name0) ] = '' }, table_mt))(), [ not_nan_and_nil('') ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(Name0) ] = '' }, table_mt))() do
