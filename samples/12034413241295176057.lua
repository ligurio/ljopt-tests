...
---------------------- END OF PREAMBLE ----------------------------
Name0:Name0  (setmetatable({  }, table_mt))()[-416.000000 ^ 116.956893], Name0:Name0  (setmetatable({  }, table_mt))():z  (setmetatable({  }, table_mt))()[''] , Name0.____________________  = 0.000000, '',  (setmetatable({  }, table_mt))(), nil, Name0 ; 
Name0 = '' ; 
