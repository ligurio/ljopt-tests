...
---------------------- END OF PREAMBLE ----------------------------
Name0 = '',  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({  (setmetatable({ not   (setmetatable({ Name0  (setmetatable({  }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))(), 0.000000 or 0.000000 ; 
