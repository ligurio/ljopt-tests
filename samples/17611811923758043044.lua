...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(0.000000), always_number(310.562500) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(2.000000), always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number(1000.000000 * -0.000050 * '') do
...
for Name0 = always_number(-0.000397), always_number(Name0:____________________  (setmetatable({  }, table_mt))()) do
