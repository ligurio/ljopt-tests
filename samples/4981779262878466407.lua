...
Name0.Name, ('' == nil)[0.000000] , Name0:Name0  (setmetatable({  }, table_mt))()[0.000000] , Name0:Name0  (setmetatable({  }, table_mt))()[ (setmetatable({ Name0 = ''; }, table_mt))() ==  (setmetatable({ Name0 = ''; Name0 = ''; }, table_mt))() == 0.000000]  = nil, not   ... , -  ... , ('while' or false), function ( ... )
