...
counter_2 = 0
counter_3 = 0
for ____________________ = always_number(0.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
local Name0; 
for Name0 = always_number(''), always_number(''), always_number(108.750000 ^ 108.750000 ^ -21.152344 ^ -11.576172) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
Name0 = '' ; 
for Name0 = always_number(1.500000), always_number(''), always_number(1.500000) do
