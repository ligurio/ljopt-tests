...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
if  (setmetatable({ [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil('') ] = Name0 }, table_mt))()) ] = (Name0 .. 358.089634 ^ 0.000000 .. Name0 % ''), Name0 = '', Name0 = '' }, table_mt))() then
	Name0 = '' ; 
do
end
; 
