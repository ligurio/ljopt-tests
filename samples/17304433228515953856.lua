...
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0:Name0  (setmetatable({  }, table_mt))(); 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  (setmetatable({  }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  (setmetatable({  }, table_mt))(); }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))() }, table_mt))() do
