...
---------------------- END OF PREAMBLE ----------------------------
Name0:Name0  (setmetatable({  }, table_mt))()[ (setmetatable({  }, table_mt))()], Name0:Name0  (setmetatable({  }, table_mt))():z  (setmetatable({  }, table_mt))()[Name0 or  (setmetatable({  }, table_mt))()] , Name0['' or  (setmetatable({  }, table_mt))()]  = '' ; 
Name0 = '' ; 
