...
until ''; 
for Name4 = always_number(''), always_number(nil), always_number('instunroll') do
...
; 
until ''; 
for instunroll = always_number(# #  (setmetatable({  }, table_mt))()), always_number(''), always_number('instunroll') do
if counter_5 > 5 then break end
counter_5 = counter_5 + 1;
break; 
end
; 
for Name4 = always_number(not  ''), always_number(nil), always_number('instll') do
