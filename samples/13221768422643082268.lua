...
Name0 =  (setmetatable({  (setmetatable({ Name0 = '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))() }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0 = '', Name0 }, table_mt))() ; 
end
; 
