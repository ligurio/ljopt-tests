...
counter_2 = 0
counter_3 = 0
Name0, Name0.Name , Name0.Name , Name0.Name , Name0 , Name0 , Name0 , Name0  = '' ; 
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = not   ... , [ not_nan_and_nil(Name0) ] = '', Name0 }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(Name0), always_number(''), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(Name0), always_number(''), always_number(0.000000) do
