...
; 
Name0 = '' ; 
Name0:Name0  (setmetatable({  }, table_mt))()[''], Name0:Name0  (setmetatable({  }, table_mt))()[false] , Name0 , Name0:Name0  (setmetatable({  }, table_mt))()[''] , Name0 , Name0:Name0  (setmetatable({  }, table_mt))()[''] , Name0 , Name0[1.000000]  = '', '' ; 
end
; 
for __false______ in ''  do
