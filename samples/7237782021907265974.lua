...
---------------------- END OF PREAMBLE ----------------------------
Name0, Name0 , utf8_len , ( (setmetatable({ Name0 = '', utf8_len = '' }, table_mt))())[#  (setmetatable({  }, table_mt))()] , ( (setmetatable({ [ not_nan_and_nil('Y') ] = '', }, table_mt))())[#  (setmetatable({  }, table_mt))()] , Name0 , Name0:Name0  (setmetatable({  }, table_mt))()[''] , ( (setmetatable({  }, table_mt))())[# ''] , ( (setmetatable({ [ not_nan_and_nil('Y') ] = '' }, table_mt))())[#  (setmetatable({  }, table_mt))()]  = not   (setmetatable({  }, table_mt))() ; 
