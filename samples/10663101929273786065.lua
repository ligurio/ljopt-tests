...
counter_3 = 0
counter_4 = 0
for Name0 = always_number(0.000000), always_number(Name0:Name0  (setmetatable({  }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name1 = always_number(-0.000000), always_number(1000.000000) do
...
; 
for Name0 = always_number(''), always_number(16.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
local function _ (  )
	if counter_3 > 5 then return end
counter_3 = counter_3 + 1;
for _ = always_number(-0.000000), always_number(1000.000000) do
