...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for ___E2 = always_number(false), always_number(0.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
if  (setmetatable({ -1000.000000 + -1000.000000 + -1000.000000 - -1000.000000 * -1000.000000 * -1000.000000 .. '0.3E2' }, table_mt))() then
	end
; 
end
; 
