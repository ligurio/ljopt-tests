...
Name0, Name0[-2.750000] , Name0 , Name0 , Name0 , Name0 , Name0  =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({  }, table_mt))(), 0.000000,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0, '', Name0 ; 
until not  ''; 
