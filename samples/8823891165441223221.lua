...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil('' == '') ] =  (setmetatable({  }, table_mt))(); [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil( ... ) ] = ''; Name0 = '', }, table_mt))()) ] =  (setmetatable({  }, table_mt))() }, table_mt))()), always_number('\023\000'), always_number(Name0) do
