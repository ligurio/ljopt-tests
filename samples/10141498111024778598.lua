...
; 
for Name0 = always_number(''), always_number(Name0.________), always_number(-0.000031) do
...
Name0.recunroll_ = 432.031250 ; 
for Name4 = always_number(false), always_number(''), always_number(1.664063) do
...
; 
for Name0 = always_number(-1.500000), always_number('') do
