...
---------------------- END OF PREAMBLE ----------------------------
do
if  (setmetatable({ '', Name0 = '', Name0 = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() then
	end
; 
end
; 
local Name4 = not  '', not  '', '', nil, nil, nil, nil, '', '' == not   (setmetatable({ '', Name0 = '', [ not_nan_and_nil(-0.000050) ] = '' }, table_mt))() ; 
