...
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil(Name0[not   (setmetatable({ Name0 = '' }, table_mt))()].Name) ] = '', Name0 = '', false_1 = '', false_1 = '', }, table_mt))()), always_number(''), always_number(416.000000) do
