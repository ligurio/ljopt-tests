...
---------------------- END OF PREAMBLE ----------------------------
Name0 (); 
Name0.rap = -468.750000, (only_numbers_cmp(#  (setmetatable({  }, table_mt))() and #  (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '', '' }, table_mt))()) ] = '', -104.000000 }, table_mt))(), '>=', '')) % Name0, -468.750000 ; 
