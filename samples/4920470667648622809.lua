...
for Name0 = always_number(2.000000), always_number(Name0 ('' ==  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))() )  (setmetatable({  }, table_mt))()), always_number(1000.000000 * '' * '') do
...
; 
for Name0 = always_number(-0.000050), always_number(''), always_number(nil) do
