...
---------------------- END OF PREAMBLE ----------------------------
Name0 =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = true; Name0 = ''; [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() }, table_mt))(), '' ; 
