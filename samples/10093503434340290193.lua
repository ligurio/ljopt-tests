...
counter_3 = 0
Name0 = '' ; 
for _ = always_number(# ''), always_number(-1000.000000), always_number(-1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name2 = always_number(function ( Name0 )
...
), always_number(0.000000), always_number( ... ) do
