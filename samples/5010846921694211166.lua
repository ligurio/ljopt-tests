...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name8 = always_number(''), always_number(0.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
if  (setmetatable({ (-1000.000000 + '0.3E2' == '0.3E2') .. 0.000000; [ not_nan_and_nil(108.750000 ^ -128.250000 ^ 108.750000) ] = '' }, table_mt))() then
	Name0 = '' ; 
end
; 
end
