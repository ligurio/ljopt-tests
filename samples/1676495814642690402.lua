...
; 
while  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil(false) ] = nan, Name0 = '', [ not_nan_and_nil(true) ] = 10.062745, [ not_nan_and_nil(false) ] = ( (setmetatable({ [ not_nan_and_nil('') ] = nil }, table_mt))()) }, table_mt))(), Name0 = '' }, table_mt))() do
