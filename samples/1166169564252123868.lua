...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(''), always_number(48.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil(9.000000) ] = -128.000122, Name0 = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(9.000000) ] =  ...  }, table_mt))() do
