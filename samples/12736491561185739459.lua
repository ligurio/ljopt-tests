...
for Name6 = always_number(Name0), always_number(0.125000) do
...
; 
for Name6 = always_number(Name0), always_number(0.002619) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name6 = always_number(Name0), always_number(4.000000), always_number('') do
...
; 
for Name6 = always_number(Name0), always_number(-0.000000), always_number(2.000000) do
