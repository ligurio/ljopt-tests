...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(''), always_number(0.000000), always_number(-2.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name4 = always_number(-2.000000), always_number(-2.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name4 = always_number(-2.000000), always_number(2.000000), always_number(Name0) do
