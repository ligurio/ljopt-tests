...
counter_4 = 0
counter_5 = 0
for Name8 = always_number(''), always_number(-468.750000), always_number(false) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for _ = always_number(-468.753906), always_number(function (  )
...
; 
for _ = always_number(-468.750000), always_number(-468.750000) do
