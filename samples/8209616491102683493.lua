...
while  (setmetatable({ [ not_nan_and_nil(-415.500000) ] = '', [ not_nan_and_nil('') ] =  ... , [ not_nan_and_nil('') ] =  ...  }, table_mt))() do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
while  (setmetatable({ Name0 = '', [ not_nan_and_nil(1.500000) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] =  ...  }, table_mt))() do
