...
counter_0 = 0
Name0 = '' ; 
function ____________________.____________________:____________________(  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
Name0 = '' ; 
Name0['' and 7.000000], ('')[Name0 or ''] , _______ , Name0:Name0  (setmetatable({  }, table_mt))()['' or nil]  =  nil ; 
end
; 
