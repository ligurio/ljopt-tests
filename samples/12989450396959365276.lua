...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ Name0 = '', nan, [ not_nan_and_nil(not   (setmetatable({ Name0 = ''; }, table_mt))() == '') ] = '', nan; Name0 = '', [ not_nan_and_nil(true) ] = nan, 0.000000 + -1000.000000 ^ 84.000000, Name0:Name0  (setmetatable({  }, table_mt))(), }, table_mt))() do
