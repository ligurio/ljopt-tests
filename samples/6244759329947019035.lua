...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
local Name0, Name0, ____________________, _; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0, Name1  =  (setmetatable({ Name0 =  (setmetatable({ Name0 =  (setmetatable({ Name0 =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() }, table_mt))() }, table_mt))() ; 
function Name0.Name0.Name0.Name0.Name0:_(  )
