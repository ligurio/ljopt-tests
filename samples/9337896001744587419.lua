...
---------------------- END OF PREAMBLE ----------------------------
local Name0 =  (setmetatable({ [ not_nan_and_nil(-1000.000000 + -1000.000000 + -1000.000000 - 'string.gmatch' ^ -1000.000000 == -1000.000000) ] = -1000.000000; [ not_nan_and_nil('') ] = -1000.000000, Name0 = '', Name0 = '', Name0 = '', }, table_mt))() ; 
if '' then
	else
	Name0 = '' ; 
end
