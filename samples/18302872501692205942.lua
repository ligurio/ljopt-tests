...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0 =  (setmetatable({ -0.000000, -0.000000, -0.000000, -0.000000, -1000.000000, Name0, Name0 = '', '', }, table_mt))(), '' ; 
for Name2 = always_number(0.000000), always_number(''), always_number(false) do
