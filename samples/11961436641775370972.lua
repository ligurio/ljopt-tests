...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(2.000000), always_number(16.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(Name0), always_number(false), always_number(-0.281250) do
...
]  = '',  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
end
; 
end
; 
