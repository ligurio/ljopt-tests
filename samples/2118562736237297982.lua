...
until nil; 
for Name5 = always_number(true), always_number(''), always_number(0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(''), always_number( (setmetatable({ -0.000000 }, table_mt))()), always_number('') do
