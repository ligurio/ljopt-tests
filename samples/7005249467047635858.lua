...
while  (setmetatable({  (setmetatable({ 0.000000 == only_numbers_cmp(#  (setmetatable({ 4.000130; Name0 = '' }, table_mt))(), '<=', ''), Name0 = '' }, table_mt))() }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
until ''; 
while  (setmetatable({ 4.000131; Name0 = ''; }, table_mt))() do
