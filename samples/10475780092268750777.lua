...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0, Name0 , Name0 , Name0.____________________:Name0  (setmetatable({  }, table_mt))()['']  =  (setmetatable({ Name0 = '' }, table_mt))() ; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0 (-0.000000, '' ); 
Name0:Name0  (setmetatable({  }, table_mt))(); 
Name0, Name7 , Name0 , Name0.____________________:Name0  (setmetatable({  }, table_mt))()['']  =  (setmetatable({ Name0 = '' }, table_mt))() ; 
function Name0.Name0.Name0(  )
