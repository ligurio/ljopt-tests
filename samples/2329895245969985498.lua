...
counter_1 = 0
counter_2 = 0
Name0 =  (setmetatable({  (setmetatable({ function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
return; 
end
 .. only_numbers_cmp(not   ... , '<', '') }, table_mt))() }, table_mt))() ; 
do
Name0 = '' ; 
end
; 
for ____ = always_number(''), always_number(Name0), always_number(0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(''), always_number(nil) do
