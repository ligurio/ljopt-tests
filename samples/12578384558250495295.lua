...
for ________ = always_number(Name0), always_number(''), always_number(0.000000 + -1000.000000 ^ 84.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name9 = always_number(____________________), always_number(-0.000000), always_number('') do
