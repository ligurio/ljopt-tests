...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({ [ not_nan_and_nil(-0.000000) ] = 163.449388, [ not_nan_and_nil(1.945313) ] = Name0:Name0  (setmetatable({  }, table_mt))(), Name0 = '', Name0 = '', [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))() do
