...
counter_0 = 0
Name0 = '' ; 
for Name9 = always_number(''), always_number(2.125000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))() }, table_mt))() ; 
end
; 
