...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(-0.000000), always_number(only_numbers_cmp('', '>=', not  nil)), always_number(-0.000000) do
...
; 
for Name0 = always_number(''), always_number(0.500000), always_number('') do
