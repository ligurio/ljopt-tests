...
counter_1 = 0
counter_2 = 0
while  (setmetatable({ Name0 = '', [ not_nan_and_nil('' .. '' / '44444444444444444444') ] = '' .. '' / '44444444444444444444', [ not_nan_and_nil('' / '' / '44444444444444444444') ] = function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
, Name0 = '', (Name0); }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = '' ; 
end
; 
while not   (setmetatable({ Name0 = '' }, table_mt))() do
