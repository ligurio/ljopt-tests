...
Name0, Name0 , Name0.cal , Name0 , Name0  =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil('') ] =  ...  }, table_mt))(), not   (setmetatable({  }, table_mt))(), nil ; 
