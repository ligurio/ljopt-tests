...
---------------------- END OF PREAMBLE ----------------------------
Name0 = '' ; 
Name0._ = # not  not  1000.000000, '' ; 
Name0 = '' ; 
Name0 = '' ; 
Name0, Name4 , Name0 , (not  1000.000000)[not  '']  = '', not  not  0.000000, not  not  false, not   (setmetatable({  }, table_mt))(), not   (setmetatable({  }, table_mt))() ; 
Name0 = not  false, - not  false, not  not  not  '', not  false ; 
