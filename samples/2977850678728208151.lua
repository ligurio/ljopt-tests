...
while  (setmetatable({ [ not_nan_and_nil(0.000000) ] =  (setmetatable({  }, table_mt))(), Name0 = '', [ not_nan_and_nil(false) ] =  (setmetatable({ Name0 = '' }, table_mt))(), [ not_nan_and_nil(-0.242187) ] =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))() do
