...
---------------------- END OF PREAMBLE ----------------------------
do
if  (setmetatable({ '', Name0 = '', [ not_nan_and_nil(-0.000050) ] = '' }, table_mt))() then
	end
; 
end
; 
local maxircons = not  '', not  '', '', nil, nil, nil, nil, '', '' == not   (setmetatable({ '', Name0 = '', [ not_nan_and_nil(-0.000050) ] = '' }, table_mt))() ; 
