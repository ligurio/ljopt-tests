...
Name0 =  (setmetatable({  }, table_mt))(), true,  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '',  (setmetatable({ Name0 = ''; }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), not  Name0:Name0  (setmetatable({  }, table_mt))() ; 
end
; 
