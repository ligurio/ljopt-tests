...
; 
for Name6 = always_number(# -0.121246 * -0.000050 * -0.000050 * 416.000000 / -0.000050), always_number(-1000.000000), always_number(-1000.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for re = always_number(# ''), always_number(-1000.000000), always_number(416.000000 / -0.000050) do
