...
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil(true) ] = '', [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(false) ] = '' }, table_mt))() do
