...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
Name0 = '',  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))() }, table_mt))(), }, table_mt))() ; 
Name0 = ( (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))()), '', '', 1000.000000, true, 1000.000000 ; 
