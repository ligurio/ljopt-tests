...
counter_2 = 0
counter_3 = 0
for __ = always_number(''), always_number(-2.750000 ..  (setmetatable({  }, table_mt))()), always_number(function ( ... )
...
; 
for __ = always_number(''), always_number(-2.750000 ..  (setmetatable({  }, table_mt))()), always_number(function ( Name0, ... )
...
; 
Name0, Name0[Name0:Name0 (0.000000 )]  = '' ; 
