...
counter_1 = 0
Name0 = '' ; 
while  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] =  (setmetatable({  }, table_mt))() }, table_mt))(), [ not_nan_and_nil('') ] =  (setmetatable({  }, table_mt))() }, table_mt))() do
