...
counter_2 = 0
counter_3 = 0
while  (setmetatable({ '', [ not_nan_and_nil('') ] = ''; [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ '', [ not_nan_and_nil(-1000.000000) ] =  ... , [ not_nan_and_nil('') ] = ''; }, table_mt))() do
