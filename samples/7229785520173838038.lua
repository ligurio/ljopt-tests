...
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil( ... ) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(((true))) ] =  (setmetatable({  }, table_mt))() }, table_mt))()), always_number(''), always_number(-0.000000 .. 358.089695 ^ 118.784988) do
