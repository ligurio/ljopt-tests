...
---------------------- END OF PREAMBLE ----------------------------
( (setmetatable({  }, table_mt))()).Name, Name0:Name0  (setmetatable({  }, table_mt))()[Name0 *  (setmetatable({  }, table_mt))()] , Name0  = '' ; 
( (setmetatable({ '', ''; Name5 = '' }, table_mt))()).Name, ( (setmetatable({ '', -0.000000 }, table_mt))()).Name , Name0  = '' ; 
( (setmetatable({  }, table_mt))()).Name, Name0:Name0  (setmetatable({  }, table_mt))()[Name0 or  (setmetatable({  }, table_mt))()] , Name0  = '' ; 
