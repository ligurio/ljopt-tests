...
counter_5 = 0
counter_6 = 0
for UUUUUUUUUUUUUUUUUUUU = always_number('UUUUUUUUUUUUUUUUUUUU'), always_number('UUUUUUUUUUUUUUUUUUUU'), always_number('UUUUUUUUUUUUUUUUUUUU') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for UUUUUUUUUUUUQUUUUUUU = always_number('UUUUUUUUUUUUUUUUUUUU'), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for UUUUUUUUUUUUUUUUUUUU = always_number('UUUUUUUUUUUUUUUUUUUU'), always_number('') do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for UUUUUUUUUUUUQUUUUUUU = always_number(''), always_number(nil), always_number('UUUUUUUUUUUUUUUUUUUU') do
...
; 
for UUUUUUUUUUUUQUUUUUUU = always_number(nil), always_number('UUUUUUUUUUUUUUUUUUUU') do
if counter_5 > 5 then break end
counter_5 = counter_5 + 1;
end
; 
for UUUUUUUUUUUUUUUUUUUU = always_number(''), always_number(''), always_number('UUUUUUUUUUUUUUUUUUUU') do
