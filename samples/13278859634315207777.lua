...
Name0, ________  =  (setmetatable({ [ not_nan_and_nil('') ] = Name0[''] }, table_mt))(), '' ; 
end
; 
for Name2 = always_number(-0.000000), always_number(44.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 =  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ [ not_nan_and_nil('') ] = Name0[-0.000000] }, table_mt))() }, table_mt))(), '' ; 
end
; 
