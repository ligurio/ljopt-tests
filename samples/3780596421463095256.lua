...
for Name0 = always_number(''), always_number(Name0), always_number(Name0:Name4  (setmetatable({  }, table_mt))()) do
...
; 
Name0 = -1000.000000,  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({  }, table_mt))() }, table_mt))(), '' ; 
end
; 
