...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(-2.093750), always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = not  '', [ not_nan_and_nil((0.000000 .. 358.089695 ^ 116.964004) % -3.500000) ] = '' }, table_mt))()) do
