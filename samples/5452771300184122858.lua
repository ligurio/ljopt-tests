...
---------------------- END OF PREAMBLE ----------------------------
if nil and not  true and '' or '' then
	Name0 = '' ; 
Name0.Name, Name0 , Name0 , Name0:Name0  (setmetatable({  }, table_mt))().Name , Name0:Name0  (setmetatable({  }, table_mt))().ffi_cdef , Name0.math_cosh , Name0  = '', nan, '' ; 
Name0:Name0  (setmetatable({  }, table_mt))().Name, Name0 , Name0 , Name0 , Name0.Name , _ , Name0 , Name0  = 0.000000, nil, not  true ; 
end
; 
if -0.000237 then
	end
