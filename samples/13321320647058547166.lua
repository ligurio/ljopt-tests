...
counter_6 = 0
counter_7 = 0
for Name0 = always_number(-2.000000), always_number(false), always_number(-2.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(Name0), always_number(0.000488) do
...
; 
for Name0 = always_number(4.000130), always_number(-38.000000), always_number(-2.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name6 = always_number(Name0), always_number(1.500000) do
...
; 
for Name0 = always_number(4.000130), always_number(-2.000000), always_number(-2.000000) do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
for Name6 = always_number(-2.000000), always_number('') do
...
; 
for Name0 = always_number(-0.000031), always_number(-38.000000), always_number(-2.000000) do
if counter_6 > 5 then break end
counter_6 = counter_6 + 1;
for Name6 = always_number(Name0), always_number(0.000488) do
