...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
while  (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '', [ not_nan_and_nil('') ] = '' }, table_mt))() do
