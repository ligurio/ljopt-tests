...
Name1 =  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))(), Name0 = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))(), Name0 = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() ; 
end
; 
