...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for _ = always_number(''), always_number(2.001953), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0, Name8  =  (setmetatable({  }, table_mt))(), Name0, '', '' ; 
Name0, Name7 , Name0  =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))() ; 
Name0, Name7 , Name8  =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))() ; 
end
; 
