...
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', Name0 = '', [ not_nan_and_nil(function (  )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
end
) ] = '', -0.000000, nan, true, [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] = '', -0.000000, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))() do
