...
Name0 = '' ; 
for Name0 = always_number(-1.500000), always_number(0.000000), always_number(false) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(true), always_number(-1.500000), always_number(-1.500000) do
