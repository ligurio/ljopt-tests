...
counter_3 = 0
counter_4 = 0
for _ = always_number(4.000000), always_number(4.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(''), always_number(4.031250) do
...
; 
Name0 = '' ; 
for _ = always_number(''), always_number('') do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
for _ = always_number(1000.000000), always_number('') do
