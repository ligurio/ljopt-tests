...
for Name4 = always_number(0.000000), always_number(0.000000), always_number(-0.000130) do
...
; 
if '' then
	elseif Name0.Name then
	end
; 
for Name4 = always_number(0.000000), always_number( (setmetatable({  }, table_mt))()) do
