...
for Name0 = always_number(0.000000), always_number(1.000000), always_number( ... ) do
...
break; 
until ''; 
for Name0 = always_number(''), always_number(1.000000) do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
for Name0 = always_number(true), always_number(1.000000), always_number( ... ) do
