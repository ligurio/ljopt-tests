...
counter_5 = 0
counter_6 = 0
for Name6 = always_number(-0.000000), always_number(-0.000000), always_number(0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name6 = always_number(''), always_number(0.000000), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name6 = always_number(44.064637), always_number(nil), always_number(-0.000000) do
...
; 
local function Name6 (  )
	if counter_3 > 5 then return end
counter_3 = counter_3 + 1;
end
; 
for Name0 = always_number(nil), always_number(0.000000), always_number(-0.000000) do
if counter_4 > 5 then break end
counter_4 = counter_4 + 1;
for Name6 = always_number(44.062500), always_number(0.000000), always_number(-0.000000) do
if counter_5 > 5 then break end
counter_5 = counter_5 + 1;
end
; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name6 = always_number(-0.000000), always_number('/') do
