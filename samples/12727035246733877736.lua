...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for sink = always_number(''), always_number(''), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 =  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), ( (setmetatable({  }, table_mt))()),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '', '', '',  (setmetatable({ Name0 }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  (setmetatable({  }, table_mt))() }, table_mt))(), not  '' == '' ; 
end
; 
