...
Name0 = '' ; 
Name0 = '' ; 
local Name0 = -2.003906 == '' ; 
repeat
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for ____________________ = always_number(''), always_number( (setmetatable({ -0.000000 }, table_mt))()), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 

until  (setmetatable({ 0.000000, }, table_mt))(); 
