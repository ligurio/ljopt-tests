...
counter_1 = 0
counter_2 = 0
for Name0 = always_number(-2.000000), always_number(function (  )
...
for Name0 = always_number( (setmetatable({ true, false_1 = '', [ not_nan_and_nil('') ] = false, }, table_mt))()), always_number(''), always_number(416.000000) do
