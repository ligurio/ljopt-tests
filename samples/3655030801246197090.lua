...
for Name0 = always_number(false), always_number(-0.000000), always_number(-960.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
for Name0 = always_number(true), always_number(-0.000000), always_number(-1000.000000) do
