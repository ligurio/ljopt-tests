...
counter_2 = 0
counter_3 = 0
local Name0, Name0, Name2, Name0, Name0, Name4, Name0, Name0, Name4, Name0, Name0, Name0, Name0; 
for Name0 = always_number(''), always_number(''), always_number('@') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = '' ; 
for Name2 = always_number(''), always_number(''), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = '' ; 
local function Name4 (  )
	if counter_2 > 5 then return end
counter_2 = counter_2 + 1;
end
; 
for Name2 = always_number(''), always_number(''), always_number(-0.000000) do
