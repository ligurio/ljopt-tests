...
; 
for Name0 = always_number(-2.003906), always_number('') do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
for Name0 = always_number(4.000000), always_number(Name0:Name0  (setmetatable({  }, table_mt))()), always_number(Name0) do
