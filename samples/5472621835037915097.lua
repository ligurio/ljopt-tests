...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(1.945313) ] = Name0:Name0  (setmetatable({  }, table_mt))(), [ not_nan_and_nil(function ( Name0 )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
) ] = Name0, Name0 = '', [ not_nan_and_nil(true) ] = '', }, table_mt))() do
