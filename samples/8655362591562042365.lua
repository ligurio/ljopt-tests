...
until  (setmetatable({ [ not_nan_and_nil(true) ] = -0.000050, Name0 =  (setmetatable({ Name0 = '', not  false }, table_mt))(); [ not_nan_and_nil('') ] = -0.000050,  ... ; [ not_nan_and_nil('') ] = -0.000050,  ...  }, table_mt))(); 
