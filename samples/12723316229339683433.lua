...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
while  (setmetatable({  (setmetatable({  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(), Name0 = '', }, table_mt))(), Name0 = '', [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] =  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(), Name0 = '' }, table_mt))() do
