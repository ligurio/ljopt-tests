...
counter_4 = 0
counter_5 = 0
for Name2 = always_number(''), always_number(false) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
local Name0 = 0.000000, '' ; 
for Name0 in function ( juntiltachmaxsnap, juntiltachmaxqnap, juntachmaxqnapnap, juntiltachmahqnap, juntiltachmaxqnap, ... )
	if counter_1 > 5 then return end
counter_1 = counter_1 + 1;
jun_tiltachmaxqnap, juntiltachmaxqnap , juntiltachmaxqnap  = function (  )
...
; 
for Name4 = always_number(''), always_number(false) do
