...
counter_0 = 0
counter_1 = 0
while '' .. '' .. only_numbers_cmp('', '>=', Name0) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
while  (setmetatable({ [ not_nan_and_nil('') ] = only_numbers_cmp('', '>=', only_numbers_cmp('', '<', '')), [ not_nan_and_nil(only_numbers_cmp('', '<', '')) ] = '', Name0 = '', Name0 = '' }, table_mt))() do
