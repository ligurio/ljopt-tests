...
counter_0 = 0
Name0 = '' ; 
for _ = always_number(''), always_number(0.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = 2.000000,  (setmetatable({ [ not_nan_and_nil(2.000000) ] = '', [ not_nan_and_nil(Name0) ] =  (setmetatable({  }, table_mt))() }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(2.000000) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() ; 
end
; 
