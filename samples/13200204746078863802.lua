...
counter_2 = 0
counter_3 = 0
for Name0 = always_number(true), always_number(-468.796631), always_number(-468.750000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
local Name4 = true, nil or true ; 
Name0 = '' ; 
if nil and '' ~= '' == '' or true then
	end
; 
end
; 
for Name0 = always_number(-468.750000), always_number(-468.750000), always_number(function ( ... )
