...
counter_2 = 0
counter_3 = 0
Name0, Name0 , Name0  =  (setmetatable({  }, table_mt))(), Name0, '' ; 
for Name0 = always_number(-0.000000), always_number(0.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = '' ; 
for __ = always_number(''), always_number(0.000000), always_number(-0.000000) do
...
; 
for Name4 = always_number(''), always_number(0.000000), always_number(-0.000000) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
Name0, Name0 , Name0 , Name0  =  (setmetatable({  }, table_mt))(), Name0, '' ; 
end
; 
end
; 
