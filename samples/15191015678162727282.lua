...
counter_0 = 0
counter_1 = 0
for Name6 = always_number(-2.000000), always_number(true), always_number(true) do
...
; 
for Name0 = always_number(-2.000211), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name0.________________  =  (setmetatable({ not  '' .. Name0  (setmetatable({  }, table_mt))()  (setmetatable({  }, table_mt))() == '', Name0 = '' }, table_mt))(), nil ; 
end
; 
