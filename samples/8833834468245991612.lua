...
counter_1 = 0
Name0 = '' ; 
for Name7 = always_number(-0.000000), always_number('?'), always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '' }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = '' ; 
for Name6 in #  (setmetatable({ Name0 = '', [ not_nan_and_nil(-1000.000000 * only_numbers_cmp(0.000000, '<', '') / -1000.000000) ] = -1000.000000, }, table_mt))(), ''  do
