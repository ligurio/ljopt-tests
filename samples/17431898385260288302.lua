...
---------------------- END OF PREAMBLE ----------------------------
local Name0 = '', false, 0.000000, ( (setmetatable({ '' }, table_mt))()) % nil, Name0:Name0  (setmetatable({  }, table_mt))(), -0.000031, 10.500000, '\\', -2.500031, -2.000000, 8.500000,  ... , -1000.000000, 2.000000,  ... , 4.000000, Name0:_  (setmetatable({  }, table_mt))() ; 
Name0 = '' ; 
