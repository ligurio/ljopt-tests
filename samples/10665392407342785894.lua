...
; 
for Name0 = always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '', }, table_mt))()) ] = nil }, table_mt))() .. nil), always_number(''), always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = nil, [ not_nan_and_nil(2.000000) ] = -0.000000 }, table_mt))() .. nil) do
