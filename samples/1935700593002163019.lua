...
counter_0 = 0
counter_1 = 0
for Name6 = always_number(''), always_number(''), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = nil,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), '' == '' ; 
end
; 
for Name6 = always_number(''), always_number(''), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0[''] = nil,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), Name0, '' ; 
end
; 
