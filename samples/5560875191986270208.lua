...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
local Name0, Name0, Name0, Name0, Name2, ____________________, Name0, Name8, Name0, Name0, Name0, Name8; 
for ________ = always_number(-0.000000), always_number(-0.000000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0:Name0  (setmetatable({  }, table_mt))():Name0  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
end
; 
