...
counter_0 = 0
counter_1 = 0
while  (setmetatable({ Name0 = ''; Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', 416.000150 }, table_mt))() do
...
; 
while  (setmetatable({ Name0 = '', Name0 = '', [ not_nan_and_nil('') ] =  ... , Name0 = ''; }, table_mt))() do
