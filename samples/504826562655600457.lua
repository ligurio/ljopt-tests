...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(0.000000), always_number(-18.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
if  (setmetatable({ '', [ not_nan_and_nil(nil) ] = '', [ not_nan_and_nil(Name0) ] =  ... , [ not_nan_and_nil(Name0) ] = '', Name0 = Name0.ZZZZZZZZZZZZ }, table_mt))() then
	end
; 
end
; 
