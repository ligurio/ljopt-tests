...
while  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', Name0 = '', [ not_nan_and_nil('utf8') ] = '', nil, nan, nan, Name0 = false, [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', Name0 = '' }, table_mt))() do
