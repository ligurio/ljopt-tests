...
counter_6 = 0
counter_7 = 0
for Name0 = always_number(''), always_number(2.000000), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name0 = always_number(2.000000), always_number(2.000000), always_number(-0.000000) do
...
; 
for Name0 = always_number(0.000000), always_number(2.000000), always_number(-0.000000) do
...
; 
for Name0 = always_number(199.781250), always_number(''), always_number(-0.000000) do
