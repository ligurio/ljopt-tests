...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(nil), always_number(''), always_number(true) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
Name0.Name, Name0 , Name0 , Name0 , Name0 , ( (setmetatable({ Name0 = '', }, table_mt))()).ffi_cdef , Name0.math_cowh , ____________________ , Name0  = '', '', '' ; 
function Name0(  )
