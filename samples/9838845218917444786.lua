...
; 
while  (setmetatable({ Name0 = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name0 = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))(), [ not_nan_and_nil('') ] =  ...  }, table_mt))() do
