...
; 
for z_ in  (setmetatable({ [ not_nan_and_nil( (setmetatable({ [ not_nan_and_nil(-1000.000000) ] =  (setmetatable({  }, table_mt))(), Name0 = '', -2.750000, }, table_mt))()) ] = -1000.000000, Name0 = '', }, table_mt))()  do
