...
---------------------- END OF PREAMBLE ----------------------------
local Name0 = 8.500000, '', '',  (setmetatable({ true, [ not_nan_and_nil('') ] = '' }, table_mt))(),  (setmetatable({ nil, [ not_nan_and_nil('') ] = '' }, table_mt))(), -2.500031, 10.500000, '\\', 2.066895 == -1000.000000, true, true, 8.500000,  ... , -1000.000000, 2.000000, 4.000000, Name0:Name0  (setmetatable({  }, table_mt))() ; 
Name0 = '' ; 
