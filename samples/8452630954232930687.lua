...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
local Name0 =  (setmetatable({ [ not_nan_and_nil(-1000.000000 * function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
Name0 = '' ; 
end
) ] = -1000.000000, [ not_nan_and_nil('') ] = -1000.000000, [ not_nan_and_nil('>' * '' .. 84.062500 ^ 84.062500 * -1000.000000) ] = -1000.000000 }, table_mt))() ; 
Name0 = '' ; 
