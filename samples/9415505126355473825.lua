...
---------------------- END OF PREAMBLE ----------------------------
if  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(-0.000000) ] = '', [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))() then
	end
; 
if  (setmetatable({ [ not_nan_and_nil('') ] = '', [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))() then
	end
; 
Name0 = '' ; 
