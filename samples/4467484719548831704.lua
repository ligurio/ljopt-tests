...
---------------------- END OF PREAMBLE ----------------------------
counter_0 = 0
for Name0 = always_number(true), always_number( (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', [ not_nan_and_nil((0.000000 .. 358.089695 ^ 118.784988) % (nil .. 358.089695 and Name0:Name0  (setmetatable({  }, table_mt))())) ] = true }, table_mt))()) do
