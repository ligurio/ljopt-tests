...
---------------------- END OF PREAMBLE ----------------------------
local Name0 =  (setmetatable({ [ not_nan_and_nil(# '' * -1000.000000 * -1000.000000 + -1000.000000 * '' * false) ] = -1000.000000, [ not_nan_and_nil(-1000.000000 * '%' / nil) ] = -1000.000000, Name0 = '' }, table_mt))() ; 
Name0 = '' ; 
