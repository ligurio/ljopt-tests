...
---------------------- END OF PREAMBLE ----------------------------
if only_numbers_cmp(only_numbers_cmp('', '>', ''), '>', only_numbers_cmp(only_numbers_cmp('', '>', ''), '>', only_numbers_cmp('', '>', ''))) then
	end
; 
if only_numbers_cmp(only_numbers_cmp('', '>', ''), '>', only_numbers_cmp(only_numbers_cmp('', '>', ''), '>', only_numbers_cmp('', '>', ''))) then
	end
; 
if only_numbers_cmp(only_numbers_cmp('', '>', only_numbers_cmp('', '>', '')), '>', only_numbers_cmp(only_numbers_cmp('', '>', ''), '>', only_numbers_cmp('', '>', ''))) then
	end
; 
