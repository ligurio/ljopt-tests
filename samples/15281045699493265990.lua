...
for Name0 = always_number(0.000000), always_number(''), always_number(Name0) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
if  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '', [ not_nan_and_nil(Name0) ] = '' }, table_mt))() then
	end
; 
end
; 
