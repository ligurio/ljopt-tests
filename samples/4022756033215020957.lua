...
---------------------- END OF PREAMBLE ----------------------------
Name0, Name0 , Name0  =  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '', }, table_mt))(),  (setmetatable({ [ not_nan_and_nil('') ] =  (setmetatable({ Name0 = '' }, table_mt))() }, table_mt))(),  (setmetatable({ [ not_nan_and_nil( (setmetatable({ Name0 = '' }, table_mt))()) ] =  (setmetatable({ Name0 = '' }, table_mt))(), 0.000000 }, table_mt))() == '',  (setmetatable({ Name0 = '', Name0 = '' }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', 0.000000 }, table_mt))(),  (setmetatable({ Name0 = '' }, table_mt))(), '' ; 
Name0 = true, 2.100605 ; 
