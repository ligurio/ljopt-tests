...
; 
for Name0 = always_number(''), always_number(-12.500000), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for Name0 = always_number(-3.000078), always_number(-0.000000), always_number(Name0) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name0 = always_number(-0.000000), always_number(-0.000000), always_number(Name0) do
if counter_3 > 5 then break end
counter_3 = counter_3 + 1;
end
; 
for Name1 = always_number(Name0), always_number(Name0) do
