...
until nil; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  (setmetatable({  }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name0 = '' }, table_mt))(),  (setmetatable({ [ not_nan_and_nil(Name0) ] = '',  (setmetatable({  }, table_mt))() }, table_mt))(), -0.000000, Name0,  ... , nan }, table_mt))() do
