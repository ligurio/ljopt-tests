...
counter_1 = 0
counter_2 = 0
while  (setmetatable({ Name0 = '', Name0 = '', [ not_nan_and_nil('') ] = true, [ not_nan_and_nil(false) ] = '' }, table_mt))() do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
end
; 
Name0 = '' ; 
while  (setmetatable({ Name0 = '', '', [ not_nan_and_nil(402.695312) ] = '', [ not_nan_and_nil(false) ] = '' }, table_mt))() do
