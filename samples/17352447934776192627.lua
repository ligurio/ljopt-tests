...
counter_2 = 0
Name0 = # not  not  '' ; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(function (  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
) ] = '' }, table_mt))(), }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ Name0 }, table_mt))(), -0.000000 }, table_mt))() do
