...
counter_0 = 0
counter_1 = 0
for Name4 = always_number(''), always_number(''), always_number( (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] = '' }, table_mt))(); }, table_mt))(), }, table_mt))()) do
