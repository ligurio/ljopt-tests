...
counter_1 = 0
counter_2 = 0
Name0 = 4.000000, 1000.000000, 1000.000000, 1000.000000, 1000.000000, true, 1000.000000 ; 
for Name0 = always_number('' ==  (setmetatable({ function ( Name0, ... )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
 }, table_mt))() == ''), always_number(4.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
for ________ = always_number(Name0), always_number(Name0), always_number(Name0) do
