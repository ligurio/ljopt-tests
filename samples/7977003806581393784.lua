...
Name0, Name1  =  (setmetatable({ [ not_nan_and_nil(Name0) ] = Name0 }, table_mt))(), Name0 ; 
end
; 
...
Name0, Name1  =  (setmetatable({ [ not_nan_and_nil(Name0) ] = Name1 }, table_mt))(), Name0 ; 
end
; 
