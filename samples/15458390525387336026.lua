...
counter_0 = 0
counter_1 = 0
for Name6 = always_number(-2.000000), always_number(nil), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0.________________, Name0  = Name0, nil ; 
end
; 
for Name0 = always_number(-2.000211), always_number('') do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0, Name0.________________  =  (setmetatable({ Name0 = '', 'aaaaaaaaaaaaaaaaaaaa' }, table_mt))(), '' ; 
end
; 
