...
---------------------- END OF PREAMBLE ----------------------------
Name0  (setmetatable({ [ not_nan_and_nil(Name0  (setmetatable({ [ not_nan_and_nil(Name0  (setmetatable({ [ not_nan_and_nil(Name0  (setmetatable({  }, table_mt))()) ] = '' }, table_mt))()) ] = '' }, table_mt))()) ] = '' }, table_mt))(); 
