...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(3.000000), always_number(3.000000 - '' - -1000.000000 ^ 3.000000 - 3.000000), always_number(Name0  (setmetatable({  }, table_mt))() - '') do
...
; 
while Name0  (setmetatable({  }, table_mt))() do
