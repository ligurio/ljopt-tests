...
counter_0 = 0
counter_1 = 0
for Name4 = always_number(44.500000), always_number(''), always_number(-0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
Name0 = -1.062498, 3.125000, 1.999995, 44.003186, -0.000000, '', 34.000000, 4.000004, 4.000000, 3.000000, 0.000000, Name0:Name0  (setmetatable({  }, table_mt))(),  ...  ; 
end
; 
for Name4 = always_number(44.500000), always_number(''), always_number(-0.000000) do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
Name0 = -1.062498, 3.125000, 1.999995, 44.003186, 44.500000, -0.000000, Name0, 34.000000, 4.000004, 4.000000, 3.000000, '', (only_numbers_cmp('', '<=', '')), '' ; 
end
; 
