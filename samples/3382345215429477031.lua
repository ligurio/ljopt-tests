...
counter_0 = 0
counter_1 = 0
for Name0 = always_number(true), always_number(true) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for __pairs = always_number( (setmetatable({ [ not_nan_and_nil(( ... ).__pairs) ] = ''; Name0 = '', [ not_nan_and_nil('') ] = nil .. 2.000000, [ not_nan_and_nil('') ] = nil .. 2.000000, }, table_mt))()), always_number(''), always_number(416.000000) do
