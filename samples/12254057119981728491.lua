...
counter_1 = 0
counter_2 = 0
for Name0 = always_number( (setmetatable({ Name0 = '', [ not_nan_and_nil('') ] = nan, nan; Name0 = '',  ... , -0.000000; [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] = '', nan, Name0 = '', nil, ''; Name0 = '' }, table_mt))()), always_number(-0.000000), always_number(0.000000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(Name0), always_number(-0.000000), always_number(0.000000) do
