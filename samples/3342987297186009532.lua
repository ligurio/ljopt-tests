...
for Name6 = always_number(Name0), always_number(0.000488), always_number(nil) do
...
; 
for Name0 = always_number(4.000130), always_number(-38.000000), always_number(-2.500000) do
...
; 
for Name0 = always_number(4.000130), always_number(nil), always_number(-2.000000) do
