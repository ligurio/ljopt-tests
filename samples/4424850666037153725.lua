...
counter_2 = 0
counter_3 = 0
for getupvalue = always_number(''), always_number(-8.500000), always_number(-8.500000) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name4 = always_number(-0.000000), always_number(Name0), always_number(-0.000031) do
