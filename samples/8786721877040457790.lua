...
counter_4 = 0
counter_5 = 0
for Name0 = always_number(nil), always_number(''), always_number( (setmetatable({ Name0 = ''; }, table_mt))()) do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(0.000000), always_number('') do
...
; 
for Name0 = always_number(''), always_number(Name0) do
