...
until ''; 
Name0 =  ... , nil, true, false,  (setmetatable({  }, table_mt))(),  (setmetatable({  }, table_mt))(), true, '', true, '' or '', true,  (setmetatable({  }, table_mt))(), true,  (setmetatable({  }, table_mt))(), true, true,  (setmetatable({  }, table_mt))(), Name0:Name0  (setmetatable({  }, table_mt))() ; 
while '' do
