...
counter_4 = 0
local Name1; 
for Name0 = always_number(''), always_number(2.000000), always_number(-1.000000) do
...
for Name0 = always_number(2.000000), always_number(-1.000000), always_number(-1.000000) do
...
for Name0 = always_number(2.000000), always_number(-1.000001), always_number(-1.000000) do
