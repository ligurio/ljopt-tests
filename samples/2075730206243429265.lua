...
; 
while  (setmetatable({ [ not_nan_and_nil(false) ] = '', Name0 = '', Name0 = '' }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '', Name0 = '', Name0 = '' }, table_mt))(), Name0 = '' }, table_mt))() do
