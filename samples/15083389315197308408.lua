...
---------------------- END OF PREAMBLE ----------------------------
local ____________________ = '', nil, nil, nil, nil, 0.000000,  (setmetatable({ Name0 = '', }, table_mt))(), nil, nil,  (setmetatable({ Name0 = ''; }, table_mt))() ; 
local ____________________ = nil, nil, nil, '', nil, nil, nil ; 
