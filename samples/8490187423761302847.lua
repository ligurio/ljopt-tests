...
counter_0 = 0
Name0 = '' ; 
function Name0:io_write( Name0 )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
Name0 = '' ; 
end
; 
Name0.type:Name0  (setmetatable({  }, table_mt))(); 
Name0 = '' ; 
do
end
; 
Name0, Name0 , Name8  =  (setmetatable({ Name0 = '', [ not_nan_and_nil(3.000000) ] = '', [ not_nan_and_nil(288.000000) ] = '', -0.000000 }, table_mt))() ; 
do
end
; 
