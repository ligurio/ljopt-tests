...
; 
while  (setmetatable({  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))(), [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))(), [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))(), [ not_nan_and_nil(Name0) ] =  (setmetatable({ [ not_nan_and_nil(Name0) ] = '' }, table_mt))(), [ not_nan_and_nil(Name0) ] = '' }, table_mt))() do
