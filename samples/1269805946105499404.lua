...
counter_2 = 0
counter_3 = 0
for or_1 = always_number(-2.500000), always_number('') do
if counter_0 > 5 then break end
counter_0 = counter_0 + 1;
for Name0 = always_number(0.500000), always_number(''), always_number(Name0:Name0 ( (setmetatable({ [ not_nan_and_nil('') ] = function ( ... )
