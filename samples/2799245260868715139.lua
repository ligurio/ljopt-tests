...
counter_0 = 0
counter_1 = 0
for Name4 = always_number( (setmetatable({ 1000.000000, -0.000050 * -0.000050 .. -0.000050 * '', [ not_nan_and_nil('\000\000\000\000\000') ] = '', }, table_mt))()), always_number(nil), always_number(0.000000) do
