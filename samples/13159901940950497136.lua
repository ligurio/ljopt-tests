...
counter_2 = 0
counter_3 = 0
for Name6 = always_number(-5.000000 .. 'e3333'), always_number(-0.000000), always_number(0.000000) do
...
for Name6 = always_number(false), always_number(0.000000), always_number(-0.000000) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
Name0:Name0  (setmetatable({  }, table_mt))(); 
for Name6 = always_number(''), always_number(0.000000) do
