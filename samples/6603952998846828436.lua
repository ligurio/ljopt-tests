...
---------------------- END OF PREAMBLE ----------------------------
Name0:Name0  (setmetatable({  }, table_mt))()['..'], Name2  (setmetatable({  }, table_mt))()[Name0 or  (setmetatable({  }, table_mt))()] , Name0:Name0  (setmetatable({  }, table_mt))()['' ==  (setmetatable({ Name0 = '' }, table_mt))()]  = 0.000000, false, '',  (setmetatable({  }, table_mt))(), nil, #  (setmetatable({  }, table_mt))() ; 
Name0 = '' ; 
