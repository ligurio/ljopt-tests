...
counter_1 = 0
counter_2 = 0
function Name0:coroutine_resume(  )
	if counter_0 > 5 then return end
counter_0 = counter_0 + 1;
end
; 
for Name0 = always_number(''), always_number(''), always_number( (setmetatable({ nan, nan, '', Name0 = '', Name0 = '', Name0:Name0  (setmetatable({  }, table_mt))(), }, table_mt))()) do
