...
while  (setmetatable({ [ not_nan_and_nil(-415.500000) ] = '', [ not_nan_and_nil(-415.500000) ] =  (setmetatable({  }, table_mt))(), -415.500000 }, table_mt))() do
if counter_1 > 5 then break end
counter_1 = counter_1 + 1;
end
; 
while  (setmetatable({ [ not_nan_and_nil(-415.500000) ] = '', [ not_nan_and_nil(1.500000) ] =  (setmetatable({  }, table_mt))(), [ not_nan_and_nil('') ] =  ...  }, table_mt))() do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
until nil; 
for Name0 = always_number(0.000000), always_number(-415.500000), always_number(0.000000) do
