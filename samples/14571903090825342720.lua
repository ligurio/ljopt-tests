...
Name0 =  (setmetatable({ [ not_nan_and_nil(-0.000000) ] =  (setmetatable({ [ not_nan_and_nil( (setmetatable({  }, table_mt))()) ] =  (setmetatable({ Name0 = '', ________ = '' }, table_mt))() }, table_mt))() }, table_mt))(), 0.000000 ; 
end
; 
