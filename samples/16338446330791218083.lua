...
; 
for Name4 = always_number(0.000000), always_number(0.000000), always_number(-0.390625) do
if counter_2 > 5 then break end
counter_2 = counter_2 + 1;
end
; 
for Name4 = always_number(0.000000), always_number(0.000000), always_number(0.000000) do
